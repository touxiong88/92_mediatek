...
public class PerfServiceManagerImpl implements PerfServiceManager{
    ...
    private class PerfServiceThreadHandler extends Handler {
        ...
        private static final int MESSAGE_TIMER_SCN_APP_BOOST      = 8;
        ...
        public void handleMessage(Message msg) {
            try {
                switch (msg.what) {
                    ...
                    case MESSAGE_TIMER_SCN_APP_BOOST:
                    {
                        log("MESSAGE_TIMER_SCN_APP_BOOST");
                        nativePerfBoostDisable(SCN_APP_BOOST);
                        break;
                    }
        ...
        private int getScenarioTimer(int scenario) {
            switch(scenario) {
                ...
                case SCN_APP_BOOST:
                    return MESSAGE_TIMER_SCN_APP_BOOST;
