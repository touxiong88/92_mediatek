    ...
    public String getMissingTitle(Context context, int simId) {
        ...
        if (FeatureOption.MTK_GEMINI_SUPPORT == true) {
            if(PhoneConstants.GEMINI_SIM_1 == simId ){
                strTitle = context.getText(com.mediatek.internal.R.string.sim_missing_slot1).toString();
            }else{
                strTitle = context.getText(com.mediatek.internal.R.string.sim_missing_slot2).toString();
            }
        }else{
