...
/* Vanzo:tanglei on: Thu, 28 Nov 2013 16:51:43 +0800
 * bugfix #57830,always show emergency call when a phone number is emergency number
 */
        ...
        for (int i = 0; i < eccNo; i++) {
            ...
            if (emergencyNumList[i].equals(number)
                ...
                Log.d(TAG, "[isCustomizedEmergencyNumber] ecclist: " + "return true");
                return true;
            }
        }
...
/* Vanzo:tanglei on: Thu, 05 Dec 2013 10:21:36 +0800
 * bugfix #58731,110,119 can not connect, tips same as 112.
            String [] emergencyCTAList = {"120","122"};
 */

            String [] emergencyCTAList = {"112", "911", "000", "08", "110", "118", "119", "999", "120","122"};
// End of Vanzo:tanglei
