...
public class WorldPhoneOp01 extends Handler implements IWorldPhone {
    ...
    public WorldPhoneOp01(Phone phone) {
        ...
        for (int i=0; i<PhoneConstants.GEMINI_SIM_NUM; i++) {
            sGsmCi[i] = ((PhoneBase)sGsmPhone[i]).mCM;
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(TelephonyIntents.ACTION_SIM_STATE_CHANGED)) {
                ...
                if (s3gSimSlot != AUTO_SELECT_DISABLE) {
                    s3gSimSlot = intent.getIntExtra(GeminiPhone.EXTRA_3G_SIM, 0);
                }
                handle3gSwitched();
                ...
                if (serviceState != null) {
                    ...
                    sRilRadioTechnology = serviceState.getRilRadioTechnology();
