...
public final class SimInfoManager implements BaseColumns {
   ...
   /// add by mtk80601 for CT Dual SIM Indicator Feature start
     ...
     * @param ctx
     * @return the array list of currently inserted SimInfoRecord(s)
     */
    ...
    /**
     * Given an index, return the slot which the SIM is currently inserted
     * @param ctx
     * @param simInfoId the unique SimInfoRecord index in database
    ...
    /**
     * Given a SIM display name, return the slot which the SIM is currently inserted
     * @param ctx
     * @param simName the display name of the SIM card
     * @return the slot which the SIM card currently inserted, -1 indicate SIM card missing
     */
    ...
    /**
     * Get the operator of a SIM according to its IccId
     * @param ctx
     * @param iccId the IccId of SIM card
    ...
    public static int setDefaultName(Context ctx, long simInfoId, String name) {
        ...
        value.put(DISPLAY_NAME, displayName);
        logd("[setDefaultName]- name:" + defaultName + " set");
    ...
    public static int setDefaultNameEx(Context ctx, long simInfoId, String name, long nameSource) {
        ...
        logd("[setDefaultNameEx]- name:" + defaultName + " set, source:" + nameSource);
        return ctx.getContentResolver().update(uri, value, null, null);
    }
