    ...
    public static void setVtDefaultSim(ContentResolver contentResolver,
        ...
        if (!FeatureOption.MTK_BSP_PACKAGE && FeatureOption.MTK_VT3G324M_SUPPORT) {
            ...
            if (FeatureOption.MTK_GEMINI_3G_SWITCH) {
                ...
                try {
                    if(iTelephony != null) {
                        logd("iTelephony.is3GSwitchManualEnabled() = " + iTelephony.is3GSwitchManualEnabled()
                                + "; iTelephony.is3GSwitchManualChange3GAllowed() = "
                                + iTelephony.is3GSwitchManualChange3GAllowed());
                    }
                    if (iTelephony != null && !iTelephony.is3GSwitchManualEnabled()
                            && !iTelephony.is3GSwitchManualChange3GAllowed()) {
