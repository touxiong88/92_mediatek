...
public class SystemTest extends AndroidTestCase {
	...
	if (SystemProperties.get("ro.kernel.qemu").equals("1")) {
		assertNull(ServiceManager.getService(BluetoothAdapter.BLUETOOTH_MANAGER_SERVICE));
	} else {
		assertNotNull(ServiceManager.getService(BluetoothAdapter.BLUETOOTH_MANAGER_SERVICE));
