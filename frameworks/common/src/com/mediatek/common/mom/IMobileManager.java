...
public interface IMobileManager {
    ...
    public static final String VERSION_NAME = "MoMS.1.2.0";
     ...
     */
    /**
    *  Enable or disable interception controller.
    *
    * @param enable true to enable, false to disable interception controller.
    *
    */   
    public void enableInterceptionController(boolean enable);

    /**
    *  Register interception controller listener to intercept incoming call.
    *
    * @param listener interface function to determine if the incoming call can be accepted or not.
    *
    */   
