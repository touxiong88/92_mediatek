...
#define MTK_DEFINED_CASE

static const BenchmarkDesc benchmarks[] = {
#ifdef MTK_DEFINED_CASE
#if 1
    { "16:9 Single Static Window",
        1920, 1080, { 720, 1080},
        {
            {   // Window
...
#endif
    { "16:9 SurfaceView -> Home Transition",
        1920, 1080, { 720, 1080},
        {
            {   // Wallpaper
                0, staticGradient, opaque,
