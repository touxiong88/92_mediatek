...
void Slang::createPreprocessor() {
  ...
  clang::HeaderSearch *HeaderInfo = new clang::HeaderSearch(HeaderSearchOpts,
                                                            *mFileMgr,
                                                            *mDiagEngine,
                                                            LangOpts,
                                                            mTarget.get());

  llvm::IntrusiveRefCntPtr<clang::PreprocessorOptions> PreprocessorOpts =
      new clang::PreprocessorOptions();

  mPP.reset(new clang::Preprocessor(PreprocessorOpts,
                                    *mDiagEngine,
                                    LangOpts,
                                    mTarget.get(),
                                    *mSourceMgr,
...
clang::ModuleLoadResult Slang::loadModule(clang::SourceLocation ImportLoc,
