...
//const int32_t AUD_VIBRFACTORY_FILTER_COEF_Table[VIBSPK_FILTER_NUM][2][6][3] = replace for build warning
const int32_t AUD_VIBRFACTORY_FILTER_COEF_Table[VIBSPK_FILTER_NUM][36] = 
{
...
{
    return gAudioFtm->HDMI_SineGenPlayback(bEnable, dSamplingRate);
}
