...
stp_sdio_rxdbg_setup(VOID)
{
    ...
    gStpSdioRxDbgEntry = create_proc_entry(STP_SDIO_RXDBG_PROCNAME, 0664, NULL);
...
{
    gStpSdioTxDbgEntry = create_proc_entry(STP_SDIO_TXDBG_PROCNAME, 0664, NULL);
...
{
    gStpSdioOwnEntry = create_proc_entry(STP_SDIO_OWNDBG_PROCNAME, 0664, NULL);
