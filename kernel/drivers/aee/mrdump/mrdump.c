...
static ssize_t lk_log_show(struct kobject *kobj, struct kobj_attribute *attr,
			   char *page)
{
	int index;
	char *p = page;
...
static ssize_t lk_log_size_show(struct kobject *kobj, struct kobj_attribute *attr,
			   char *buf)
{
...
static ssize_t manual_dump_show(struct kobject *kobj, struct kobj_attribute *attr,
				char *buf)
{
	return sprintf(buf, "Trigger manual dump with message, format \"manualdump:Hello World\"");
}
...
static struct kobj_attribute lk_log_attribute =
	__ATTR(log, 0440, lk_log_show, NULL);

static struct kobj_attribute lk_log_size_attribute =
	__ATTR(log_size, 0440, lk_log_size_show, NULL);

static struct kobj_attribute manual_dump_attribute =
	__ATTR(manual_dump, 0600, manual_dump_show, manual_dump_store);

static struct attribute *attrs[] = {
	&lk_log_attribute.attr,
	&lk_log_size_attribute.attr,
