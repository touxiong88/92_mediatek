...
struct excel_info PartInfo[PART_NUM]={
			...
			{"android",2147483648,0x5000000, EMMC, 5,EMMC_PART_USER},
			{"cache",134217728,0x85000000, EMMC, 6,EMMC_PART_USER},
			{"usrdata",4294967296,0x8d000000, EMMC, 7,EMMC_PART_USER},
			{"fat",0,0x18d000000, EMMC, 8,EMMC_PART_USER},
