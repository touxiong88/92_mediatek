...
/*	//sunhouzan 2014-11-5 for charging 99 to 100 spend too much time
...
void check_battery_exist(void)
{
    ...
    if( baton_count >= 3)
    {
		/* Vanzo:zhangxinyu on: Wed, 26 Jun 2013 20:49:44 +0800
		 * for no battery reset
        if( (g_platform_boot_mode==META_BOOT) || (g_platform_boot_mode==ADVMETA_BOOT) || (g_platform_boot_mode==ATE_FACTORY_BOOT) )
        {
