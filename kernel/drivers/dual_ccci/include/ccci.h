...
/*22~24 reserved for smart sim switch*/ 
...
/*28 reserved for icusb*/
#define CCCI_IOC_SET_MD_IMG_EXIST		_IOW(CCCI_IOC_MAGIC, 29, unsigned int[MD_IMG_MAX_CNT])
#define CCCI_IOC_GET_MD_IMG_EXIST		_IOR(CCCI_IOC_MAGIC, 30, unsigned int[MD_IMG_MAX_CNT])
