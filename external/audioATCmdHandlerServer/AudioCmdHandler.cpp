 ...
 * $Log:$
 *
 * 10 14 2013 donglei.ji
 * [ALPS01087404] [Need Patch] [Volunteer Patch] ACF tuning for dual speaker
 * .
 *
...
ACHStatus AudioCmdHandler::DLCustACFParamToNV(void *pParam, int spkType)
{
    int write_size = 0;
    int size = 0;
    int dataLen = 0;
    ...
    SXLOGD("DLCustACFParamToNV ,acf param size: %d, speaker type is: %d", sizeof(AUDIO_ACF_CUSTOM_PARAM_STRUCT), spkType);
    AudioCompFltType_t eFltType = (spkType == MAIN_SPK_TYPE) ? AUDIO_COMP_FLT_AUDIO : AUDIO_COMP_FLT_AUDIO_SUB;
    size = GetAudioCompFltCustParamFromNV(eFltType, pACFPara);
    ...
    write_size = SetAudioCompFltCustParamToNV(eFltType, pACFPara);
    ...
    String8 keyACFUpdate = (spkType == MAIN_SPK_TYPE) ? String8("UpdateACFHCFParameters=0") : String8("UpdateACFHCFParameters=2");
    AudioSystem::setParameters(0, keyACFUpdate);
...
ACHStatus AudioCmdHandler::ULCustACFParamFromNV(void *pParam, int *len, int spkType)
{
    int size = 0;
    ...
    SXLOGD("ULCustACFParamFromNV ,acf param size: %d, speaker type: %d", sizeof(AUDIO_ACF_CUSTOM_PARAM_STRUCT), spkType);
    AudioCompFltType_t eFltType = (spkType == MAIN_SPK_TYPE) ? AUDIO_COMP_FLT_AUDIO : AUDIO_COMP_FLT_AUDIO_SUB;
    size = GetAudioCompFltCustParamFromNV(eFltType, pACFPara);
    if (size != sizeof(AUDIO_ACF_CUSTOM_PARAM_STRUCT))
    {
