...
static void DoCustACFHCFParam(AudioCmdParam &audioCmdParams, void *pParam, AudioCmdHandler *pAudioHandle)
{
    ...
    if (audioCmdParams.param1 == 0)
    {
        ...
        if (audioCmdParams.param3 == 0)
        {
            ret = pAudioHandle->ULCustACFParamFromNV(pACFHCFParam + strLen, &dataLen, audioCmdParams.param2);
        }
        else if (audioCmdParams.param3 == 1)
        {
    ...
    else
    {
        ...
        if (audioCmdParams.param3 == 0)
        {
            ret = pAudioHandle->DLCustACFParamToNV(pACFHCFParam, audioCmdParams.param2);
        }
        else if (audioCmdParams.param3 == 1)
        {
