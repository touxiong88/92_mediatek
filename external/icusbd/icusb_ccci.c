...
{		
	...
	fd_ccci_recover = open(CCCI_RECOVER_ICUSB_NOTIFY_DEV, O_RDWR | O_NONBLOCK);
...
{		
	fd_ccci_icusb = open(CCCI_TTY_ICUSB_DEV, O_RDWR | O_NOCTTY | O_NONBLOCK);
    if(fd_ccci_icusb < 0) {
