...
define transform-host-clang-diagnostic-td-to-out
  $(call transform-host-clang-td-to-out,clang-diags-defs \
      -clang-component=$(patsubst Diagnostic%Kinds.inc,%,$(notdir $@)))
endef
