...
INT32 (*gfpmtk_gps_sys_gps_mnl_callback )(MTK_GPS_NOTIFICATION_TYPE);
INT32 (*gfpmtk_gps_sys_nmea_output_to_app)(const char *,UINT32);
INT32 (*gfpmtk_gps_sys_frame_sync_enable_sleep_mode)(unsigned char);
INT32 (*gfpmtk_gps_sys_frame_sync_meas_req_by_network)(void);
INT32 (*gfpmtk_gps_sys_frame_sync_meas_req) (MTK_GPS_FS_WORK_MODE);
INT32 (*gfpmtk_gps_sys_agps_disaptcher_callback) (UINT16, UINT16, char *);
void  (*gfpmtk_gps_sys_pmtk_cmd_cb)(UINT16);
int   (*gfpSUPL_encrypt)(unsigned char *, unsigned char *, unsigned int );
int   (*gfpSUPL_decrypt)(unsigned char *, unsigned char *, unsigned int );
 ...
 *****************************************************************************/
INT32 
mtk_gps_sys_function_registery (MTK_GPS_SYS_FUNCTION_POINT_T *fp_t);
