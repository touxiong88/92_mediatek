...
#
MY_CUST_FTABLE_PATH := hal/imgsensor hal/flashlight hal/camerashot config/matv
...
#-----------------------------------------------------------
LOCAL_C_INCLUDES += $(TOP)/$(MTK_ROOT)/hardware/mtkcam/common/paramsmgr/inc
#
