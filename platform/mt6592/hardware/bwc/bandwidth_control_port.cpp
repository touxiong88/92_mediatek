...
//#ifdef FLAG_SUPPORT_SMI_SETTING
    ...
    //unsigned int read_hwc_max_pixel = 0;
    ...
    switch( profile_type )
    {
        ...
        case BWCPT_VIDEO_RECORD_SLOWMOTION:
           // Support higher frame rate record with SMI_BWC_SCEN_VR_SLOW
    ...
    // Query Max HWC pixel count
    //BWC_MONITOR bwc_monotor;
    //read_hwc_max_pixel  = bwc_monotor.query_hwc_max_pixel();
    //BWC_INFO("HWC Max Pixel Limitation: %d\n",read_hwc_max_pixel);
