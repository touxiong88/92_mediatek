...
/* Vanzo:zhangxinyu on: Mon, 16 Dec 2013 11:30:19 +0800
 * TODO: replace this line with your comment
  ...
  */
    dprintf(INFO, "[fan5405_hw_init] (0x06,0x78\n");
    fan5405_reg_config_interface(0x06,0x78); // set ISAFE and HW CV point (4.36)
    fan5405_reg_config_interface(0x02,0xae); // 4.36
