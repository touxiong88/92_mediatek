...
static struct device_driver slt_cpu4_vfp_drv =
{
    .name = "slt_cpu4_vfp",
    .bus = &platform_bus_type,
    .owner = THIS_MODULE,
...
static struct device_driver slt_cpu5_vfp_drv =
{
    .name = "slt_cpu5_vfp",
    .bus = &platform_bus_type,
    .owner = THIS_MODULE,
...
static struct device_driver slt_cpu6_vfp_drv =
{
    .name = "slt_cpu6_vfp",
    .bus = &platform_bus_type,
    .owner = THIS_MODULE,
...
static struct device_driver slt_cpu7_vfp_drv =
{
    .name = "slt_cpu7_vfp",
    .bus = &platform_bus_type,
    .owner = THIS_MODULE,
