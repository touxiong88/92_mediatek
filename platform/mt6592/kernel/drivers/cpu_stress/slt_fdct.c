...
static struct device_driver slt_cpu4_fdct_drv =
{
    .name = "slt_cpu4_fdct",
    .bus = &platform_bus_type,
    .owner = THIS_MODULE,
...
static struct device_driver slt_cpu5_fdct_drv =
{
    .name = "slt_cpu5_fdct",
    .bus = &platform_bus_type,
    .owner = THIS_MODULE,
...
static struct device_driver slt_cpu6_fdct_drv =
{
    .name = "slt_cpu6_fdct",
    .bus = &platform_bus_type,
    .owner = THIS_MODULE,
...
static struct device_driver slt_cpu7_fdct_drv =
{
    .name = "slt_cpu7_fdct",
    .bus = &platform_bus_type,
    .owner = THIS_MODULE,
