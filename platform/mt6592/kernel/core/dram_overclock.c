...
static ssize_t dram_overclock_store(struct device_driver *driver, const char *buf, size_t count)
{
    ...
    if(get_ddr_type){
      ...
      {
          DFS_phase_mt6333_config_interface(Vcore_NV_1333);  //1.1
          DFS_phase_mt6333_config_interface(Vcore_NV_1333);
      }
      else
      { 
          DFS_phase_mt6333_config_interface(Vcore_NV_1066);  //1.1
          DFS_phase_mt6333_config_interface(Vcore_NV_1066);
      }
    }
    else
    {
...
static ssize_t DFS_test_show(struct device_driver *driver, char *buf)
{
    ...
    if(DDR_1333==1)
    {
       ...
       if(V_cond==2)
       {
        DFS_phase_mt6333_config_interface(Vcore_HV_1066);   //1.1
        DFS_phase_mt6333_config_interface(Vcore_HV_1066);   //1.1
       ...
       {
        DFS_phase_mt6333_config_interface(Vcore_LV_1066);  //0.9
        DFS_phase_mt6333_config_interface(Vcore_LV_1066);  
       ...
       {
        DFS_phase_mt6333_config_interface(Vcore_HV_1066);  //1.0
        DFS_phase_mt6333_config_interface(Vcore_HV_1066);
    ...
    { 
       ...
       if(V_cond==2)
       {
        DFS_phase_mt6333_config_interface(Vcore_HV_1333);   //1.2
        DFS_phase_mt6333_config_interface(Vcore_HV_1333);   //1.2
       ...
       {
        DFS_phase_mt6333_config_interface(Vcore_LV_1333);  //1.0
        DFS_phase_mt6333_config_interface(Vcore_LV_1333);
       ...
       {
        DFS_phase_mt6333_config_interface(Vcore_HV_1333);  //1.2
        DFS_phase_mt6333_config_interface(Vcore_HV_1333);
        mt6333_config_interface(0x81, Vmem_LV_1333, 0x7F,0); //1.16
        mt6333_config_interface(0x82, Vmem_LV_1333, 0x7F,0);
       }
       else if (V_cond==4) //LVc_HVm
...
static ssize_t DFS_Voltage_show(struct device_driver *driver, char *buf)
{
    ...
    ret_val=mt6333_read_interface(0x6B,&OldVcore1);
