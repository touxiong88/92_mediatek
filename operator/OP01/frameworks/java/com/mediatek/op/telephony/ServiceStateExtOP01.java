...
public class ServiceStateExtOP01 extends ServiceStateExt {
    ...
    public int mapGsmSignalLevel(int asu){
        ...
        if (asu <= 0 || asu == 99) level = SignalStrength.SIGNAL_STRENGTH_NONE_OR_UNKNOWN;
        else if (asu >= 29) level = SignalStrength.SIGNAL_STRENGTH_HIGHEST;
        else if (asu >= 16) level = SignalStrength.SIGNAL_STRENGTH_GREAT;
        else if (asu >= 8)  level = SignalStrength.SIGNAL_STRENGTH_GOOD;
        else if (asu >= 4)  level = SignalStrength.SIGNAL_STRENGTH_MODERATE;
