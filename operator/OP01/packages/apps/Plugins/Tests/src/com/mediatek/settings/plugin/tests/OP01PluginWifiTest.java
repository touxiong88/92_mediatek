...
public class OP01PluginWifiTest extends OP01PluginBase {
    ...
    public void test02_WifiTrustandMenu() {
        ...
        if (mWifiSettingsExt.isCatogoryExist()) {
            ...
            //auto connnect is the third check box
    ...
    public void test03_WifiConnectApTypeTest() {
	    ...
	    // verify connect ap type status
	    if (!mSolo.isCheckBoxChecked(2)) {
	        if (System.getInt(mActivity.getContentResolver(), System.WIFI_CONNECT_AP_TYPE, System.WIFI_CONNECT_AP_TYPE_AUTO) != System.WIFI_CONNECT_AP_TYPE_MANUL) {
	            Xlog.i(TAG, "closed auto connect status fail");
	            assertTrue(false);
	        }
	        ...
	        if (System.getInt(mActivity.getContentResolver(), System.WIFI_CONNECT_AP_TYPE, System.WIFI_CONNECT_AP_TYPE_AUTO) != System.WIFI_CONNECT_AP_TYPE_AUTO) {
	            Xlog.i(TAG, "opened auto connect status fail");
	            assertTrue(false);
	        }
	    } else {
	        if (System.getInt(mActivity.getContentResolver(), System.WIFI_CONNECT_AP_TYPE, System.WIFI_CONNECT_AP_TYPE_AUTO) != System.WIFI_CONNECT_AP_TYPE_AUTO) {
	            Xlog.i(TAG, "2 opened auto connect status fail");
	            assertTrue(false);
	        }
	        ...
	        mSolo.sleep(TWO_THOUSANDS_MILLISECOND);
	        if (System.getInt(mActivity.getContentResolver(), System.WIFI_CONNECT_AP_TYPE, System.WIFI_CONNECT_AP_TYPE_AUTO) != System.WIFI_CONNECT_AP_TYPE_MANUL) {
	            Xlog.i(TAG, "2 closed auto connect status fail");
	            assertTrue(false);
	        }
	    }
    ...
    public void test04_WifiPriorityTypeTest() {
        ...
        // verify check box of priority set
    ...
    public void test06_WifiConnectApTest() {
        ...
        // auto connnect is the third check box, check it
        if (!mSolo.isCheckBoxChecked(2)) {
            mSolo.clickOnCheckBox(2);
        }
        mSolo.sleep(TWO_THOUSANDS_MILLISECOND);

        // manually priority is the 4th check box, check it
        if (!mSolo.isCheckBoxChecked(3)) {
            mSolo.clickOnCheckBox(3);
        }
        mSolo.sleep(TWO_THOUSANDS_MILLISECOND);
    ...
    public void test09_WifiSsidReselectTest() {
        ...
        String slect_ssid = "Wi-Fi auto switch type";
	...
	public void test10_WifiConnectTypeTest() {
	    ...
	    String connect_type = "Wi-Fi auto switch type";
    ...
    public void test14_WifiModifyApTest() {
        ...
        if (mWifiSettingsExt.isCatogoryExist()) {
            ...
            if (mSolo.searchText(advanced)) {
                ...
                mSolo.sleep(TWO_THOUSANDS_MILLISECOND);
                // auto connnect is the 3rd check box, check it
                if (!mSolo.isCheckBoxChecked(2)) {
                    mSolo.clickOnCheckBox(2);
                    mSolo.sleep(TWO_THOUSANDS_MILLISECOND);
                }
