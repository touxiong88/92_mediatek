...
class CheckGPRSProtocol extends CheckItemBase {
    ...
    public check_result getCheckResult() {
        ...
        if (getKey().equals(CheckItemKeySet.CI_GPRS_ON) ||
            ...
            SharedPreferences preference = getContext().getSharedPreferences("com.mtk.GPRS", 0);
        ...
        if (getKey().equals(CheckItemKeySet.CI_DATA_ROAM_CONFIG)) {
            ...
            if (FeatureOption.MTK_GEMINI_SUPPORT) {
                try {
                    ...
                    if (iTelephony != null) {
                        iTelephony.setDataRoamingEnabledGemini(true, mSimList.get(0).mSimSlotId);
                    }
            ...
            if (FeatureOption.MTK_GEMINI_SUPPORT) {
                try {
                    ITelephony iTelephony = 
                        ITelephony.Stub.asInterface(ServiceManager.getService(Context.TELEPHONY_SERVICE));
                    if (iTelephony != null) {
                        iTelephony.setDataRoamingEnabledGemini(
