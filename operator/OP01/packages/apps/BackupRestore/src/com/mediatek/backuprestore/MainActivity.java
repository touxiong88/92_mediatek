...
public class MainActivity extends Activity {
    ...
    // /M: modify by test case ,never call here
    /*
     * protected Dialog onCreateDialog(int id, Bundle args) {
     * 
     * MyLogger.logI(CLASS_TAG, "oncreateDialog, id = " + id); switch (id) {
     * case DialogID.DLG_DELETE_AND_WAIT: { ProgressDialog dialog = new
     * ProgressDialog(this); dialog.setCancelable(false);
     * dialog.setMessage(getString(R.string.delete_please_wait));
     * dialog.setIndeterminate(true); return dialog; }
     * 
     * case DialogID.DLG_LOADING: { ProgressDialog dialog = new
     * ProgressDialog(this); dialog.setCancelable(false);
     * dialog.setMessage(getString(R.string.loading_please_wait));
     * dialog.setIndeterminate(true); return dialog; } } return null; }
     */
