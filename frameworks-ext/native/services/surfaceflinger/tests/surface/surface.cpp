...
FRAME test_frames[] = {
    ...
    {"/data/BigShips_1280x720_1.i420", 1280, 1280,  720, HAL_PIXEL_FORMAT_I420,     NATIVE_WINDOW_API_MEDIA},
    {"/data/football_qvga_1.i420",      320,  320,  240, HAL_PIXEL_FORMAT_I420,     NATIVE_WINDOW_API_MEDIA},
    {"/data/indoor_slow_1.i420",        848,  848,  480, HAL_PIXEL_FORMAT_I420,     NATIVE_WINDOW_API_MEDIA},
    {"/data/Kimono1_1920x1088_1.i420", 1920, 1920, 1088, HAL_PIXEL_FORMAT_I420,     NATIVE_WINDOW_API_MEDIA},
    {"/data/mobile_qcif_1.i420",        176,  176,  144, HAL_PIXEL_FORMAT_I420,     NATIVE_WINDOW_API_MEDIA},
    {"/data/newyork_640x368_1.i420",    640,  640,  368, HAL_PIXEL_FORMAT_I420,     NATIVE_WINDOW_API_MEDIA},
    {"/data/out_176_144.i420",          176,  176,  144, HAL_PIXEL_FORMAT_I420,     NATIVE_WINDOW_API_MEDIA},
    {"/data/school_640x480_1.i420",     640,  640,  480, HAL_PIXEL_FORMAT_I420,     NATIVE_WINDOW_API_MEDIA},
    {"/data/prv03.i420",                640,  640,  480, HAL_PIXEL_FORMAT_I420,     NATIVE_WINDOW_API_CAMERA},
    // because the MTKYUB raw data does not contain padding bits,
    // keep the stride be the same value as width.
    // {"/data/ibmbw_720x480_mtk.yuv",     720,  720,  480, HAL_PIXEL_FORMAT_NV12_BLK, NATIVE_WINDOW_API_MEDIA},
};
