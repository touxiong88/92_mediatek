...
public class MediatekDomesticClockView extends MediatekClock {
    ...
    protected void onFinishInflate() {
        ...
        mTimeView = (TextView) findViewById(com.mediatek.internal.R.id.clock_text_domestic);
        mTimeView.setTypeface(Typeface.createFromFile(ANDROID_CLOCK_FONT_FILE));
        
        mWeekDayView  = (TextView) findViewById(com.mediatek.internal.R.id.weekday_domestic);
        mTimeView.setTypeface(Typeface.createFromFile(ANDROID_CLOCK_FONT_FILE));
        
        mAmPm = new AmPm(this, null);
        mAmPmTextView = (TextView) findViewById(com.mediatek.internal.R.id.am_pm_domestic);
        setDateFormat();
