...
public class OppHandoverReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (action.equals(BluetoothIntent.ACTION_WHITELIST_DEVICE)) {
        ...
        } else if (action.equals(BluetoothIntent.ACTION_STOP_HANDOVER)) {
            int id = intent.getIntExtra(BluetoothIntent.EXTRA_BT_OPP_TRANSFER_ID, -1);
            if (id == -1) {
        ...
        } else if (BluetoothIntent.ACTION_HANDOVER_SEND.equals(action)
