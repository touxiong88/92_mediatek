...
public class OppServerActivity extends CancelableActivity {
    ...
    protected void onActivityCancel(int id) {
        ...
        if (id == CancelableActivity.NULL_CANCEL_ID) {
            ...
            // try {
            int taskId = this.getIntent().getIntExtra(BluetoothIntent.OppsAccessRequest.EXTRA_TASK_ID, -1);
            if (taskId != id) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // OPPS Object Push
        if (BluetoothIntent.OppsAccessRequest.ACTION_PUSH_REQUEST.equals(action)) {
    ...
    protected Dialog onCreateDialog(int id) {
        ...
        switch (id) {
            case DIALOG_PUSH_CONFIRMATION:
                ...
                Intent intent = this.getIntent();
                String peerName = intent.getStringExtra(BluetoothIntent.OppsAccessRequest.EXTRA_PEER_NAME);
                String objectName = intent.getStringExtra(BluetoothIntent.OppsAccessRequest.EXTRA_OBJECT_NAME);
                long totalBytes = intent.getLongExtra(BluetoothIntent.OppsAccessRequest.EXTRA_TOTAL_BYTES, 0);
