...
public class OppClientActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Intent.ACTION_SEND.equals(action) || BluetoothIntent.ACTION_HANDOVER_SEND.equals(action)) {
            ...
            BluetoothShareTask newTask = this.newOppcTask(BluetoothShareTask.TYPE_OPPC_PUSH, type,
                    uri, BluetoothIntent.ACTION_HANDOVER_SEND.equals(action));
            if (newTask == null) {
            ...
            mIsHandover = BluetoothIntent.ACTION_HANDOVER_SEND_MULTIPLE.equals(action);
