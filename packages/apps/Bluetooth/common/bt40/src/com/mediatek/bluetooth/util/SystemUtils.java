...
public class SystemUtils {
    ...
    public static int getCurrentUserId(Context ctx) {
        ...
        IUserManager mUserManagerService = IUserManager.Stub.asInterface(b);
        UserManager userManager = new UserManager(ctx, mUserManagerService);
        userId = userManager.getSwitchedUserId();
        BtLog.d("[BT][MMI][getCurrentUserId]: userId = " + userId );
        return userId;
    }
}
