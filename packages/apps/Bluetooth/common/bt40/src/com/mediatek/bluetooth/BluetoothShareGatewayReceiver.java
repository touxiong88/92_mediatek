...
public class BluetoothShareGatewayReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        } else if (action.equals(BluetoothIntent.ACTION_OPEN_RECEIVED_FILES)) {
    ...
    private void profileDispatcher(Context context, BluetoothDevice remoteDevice) {
        ...
        if (FeatureOption.MTK_BT_PROFILE_BIP
            ...
            Intent in = new Intent(BluetoothIntent.ACTION_SEND_BIP_FILES);
            ...
            sIntent.setAllowFds(false);
            context.startActivityAsUser(sIntent, new UserHandle(SystemUtils.getCurrentUserId(context)));
        }
    }
}
