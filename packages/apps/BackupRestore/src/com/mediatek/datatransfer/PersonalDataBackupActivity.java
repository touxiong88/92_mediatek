...
public class PersonalDataBackupActivity extends AbstractBackupActivity implements
    ...
    private void registerSIMCardStatusReceiver() {
        ...
        itFilter.addAction(ACTION_PHB_LOAD_FINISHED);
    ...
    public class SIMCardStatusReceiver extends BroadcastReceiver{
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (Intent.ACTION_AIRPLANE_MODE_CHANGED.equals(intent.getAction())
					|| TelephonyIntents.ACTION_PHB_STATE_CHANGED.equals(intent
							.getAction())
            ...
            }else if(ACTION_PHB_LOAD_FINISHED.equals(intent.getAction())){
            	clearDialogs();
            	initDataTask = new InitPersonalDataTask();
          	initDataTask.execute();
            }
	...
	for (int index = 0; index < mSimCount+1; index++) {
        ...
        default:
            ...
            break;
                ...
                MyLogger.logD(CLASS_TAG, "select array length is: " + select.length);
		MyLogger.logD(CLASS_TAG, "temp array length is: " + temp.length);
        ...
        case DialogID.DLG_RESULT:
            final DialogInterface.OnClickListener listener = new DialogInterface.OnClickListener() {
                ...
                public void onClick(final DialogInterface dialog, final int which) {
                    stopService();
                    NotifyManager.getInstance(PersonalDataBackupActivity.this).clearNotification();
                }
            };
...
//        MyLogger.logD(CLASS_TAG, "SIM count = " + mSimCount);
    ...
    private class DeleteFolderTask extends AsyncTask<File[], String, Long> {
        ...
        protected Long doInBackground(File[]... params) {
            File[] files = params[0];
            for (File file : files) {
                FileUtils.deleteFileOrFolder(file,PersonalDataBackupActivity.this);
            }
        ...
        protected Long doInBackground(Void... arg0) {
            ...
            for (int i = 0; i < num; i++) {
                ...
                case ModuleType.TYPE_PICTURE:
                    ...
                    if(SDCardUtils.getInternalStorage()==null||SDCardUtils.getInternalStorage().equals("")){
                    	skipAppend = true;
                    }
                    break;
                ...
                if(!skipAppend) mBackupDataList.add(item);
            }
        	return null;
        }
    }
...
//                        + isChecked);
                ...
                config.setOnClickListener(new OnClickListener() {
                    public void onClick(View v) {
                    	...
                    	getSimInfoList();
MyLogger.logD(CLASS_TAG, "begin to show the contact config dialog");
