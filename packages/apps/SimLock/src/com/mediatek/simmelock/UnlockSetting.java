...
public class UnlockSetting extends SimLockBaseActivity {
            ...
            public void onClick(View view) {
                ...
                if ((etPwd.getText().length() < 4) || ((etPwd.getText().length() > 8))) {
                    ...
                    if (!FeatureOption.MTK_GEMINI_SUPPORT) {
                        ...
                        geminiPhone.getIccCardGemini(simNumber).setIccNetworkLockEnabled(lockCategory, 0,
    ...
    private void queryLeftTimes() {
        if (!FeatureOption.MTK_GEMINI_SUPPORT) {
            ...
            mGeminiPhone.getIccCardGemini(simNumber).QueryIccNetworkLock(lockCategory, 0, null,
