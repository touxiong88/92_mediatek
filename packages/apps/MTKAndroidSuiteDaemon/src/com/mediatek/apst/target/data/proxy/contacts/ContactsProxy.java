...
//            // / For Contact provider's change, clear all names except DisplayName
    ...
    public long insertGroup(final Group group) {
        ...
        if (FeatureOptionControl.CONTACT_N_USIMGROUP != 0
            ...
            if (!insertGroupInUSIM(group.getAccount_type(), accountName, group
                    .getTitle())) {
                Debugger.logE(new Object[] {}, "insertGroupInUSIM failed!!!!");
                return insertedId;
            }
        }
     ...
     * @param groupTitle
     */
    private boolean insertGroupInUSIM(String accountType, String accountName,
            String groupTitle) {
        if (groupTitle == null) {
            groupTitle = "";
        }
