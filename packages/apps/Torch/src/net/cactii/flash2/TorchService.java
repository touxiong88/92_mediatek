...
public class TorchService extends Service {
    ...
    public void onCreate() {
        ...
        this.mTorchTask = new TimerTask() {
            public void run() {
                FlashDevice.instance().setFlashMode(
...
/* Vanzo:huangchaojun on: Sun, 09 Oct 2011 10:31:39 +0800
 */
            Settings.System.putInt(this.getContentResolver(), "torch_strobe", 1);
// End of Vanzo:huangchaojun
        } else {
/* Vanzo:wangyi on: Thu, 11 Apr 2013 17:12:46 +0800
 * bugfix #33519
 ...
 */
            FlashDevice.instance().setFlashMode(
                    mBright ? FlashDevice.DEATH_RAY : FlashDevice.ON);
// End of Vanzo: wangyi
/* Vanzo:huangchaojun on: Sun, 09 Oct 2011 10:31:55 +0800
 */
            Settings.System.putInt(this.getContentResolver(), "torch_strobe", 0);
// End of Vanzo:huangchaojun
        }
        ...
        this.mNotification = new Notification(R.drawable.notification_icon,
                getString(R.string.not_torch_title),
                System.currentTimeMillis());
        this.mNotification.setLatestEventInfo(this, getString(R.string.not_torch_title),
                getString(R.string.not_torch_summary),
        ...
        Settings.System.putInt(this.getContentResolver(), TorchSwitch.TORCH_STATE, 1);
...
/* Vanzo:zengxiancheng on: Fri, 25 Nov 2011 18:09:03 +0800
 * modify mReceiver
...
// End of Vanzo: zengxiancheng
        ...
        Settings.System.putInt(this.getContentResolver(), TorchSwitch.TORCH_STATE, 0);
        this.sendBroadcast(new Intent(TorchSwitch.TORCH_STATE_CHANGED));
    }
