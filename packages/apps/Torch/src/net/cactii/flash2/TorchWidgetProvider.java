...
/* Vanzo:huangchaojun on: Sun, 09 Oct 2011 10:15:45 +0800
 ...
 */
            views.setTextViewText(R.id.ind, context.getString(R.string.setting_widget_strobe));
            if (!(Settings.System.getInt(context.getContentResolver(),
                    "torch_strobe", 0) == 1)) {
                views.setImageViewResource(R.id.img_torch, R.drawable.widget_off);
            }
...
/* Vanzo:huangchaojun on: Sun, 09 Oct 2011 10:17:12 +0800
