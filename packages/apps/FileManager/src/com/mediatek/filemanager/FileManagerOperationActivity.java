...
public class FileManagerOperationActivity extends AbsBaseActivity implements
    ...
    protected void showForbiddenDialog(int title, int message) {
        ...
        ft.add(forbiddenDialogFragment, FORBIDDEN_DIALOG_TAG);
    ...
    protected void showDeleteDialog() {
        ...
        FragmentTransaction ft = getFragmentManager().beginTransaction();
        ft.add(deleteDialogFragment, DELETE_DIALOG_TAG);
        ft.commitAllowingStateLoss();
    }
    ...
    protected void showRenameExtensionDialog(FileInfo srcfileInfo, final String newFilePath) {
        ...
        FragmentTransaction ft = getFragmentManager().beginTransaction();
        ft.add(renameExtensionDialogFragment, RENAME_EXTENSION_DIALOG_TAG);
        ft.commitAllowingStateLoss();
    }
    ...
    protected void showSortDialog() {
        ...
        FragmentTransaction ft = getFragmentManager().beginTransaction();
        ft.add(sortDialogFragment, ChoiceDialogFragment.CHOICE_DIALOG_TAG);
        ft.commitAllowingStateLoss();
    }
    ...
    protected void showRenameDialog() {
        ...
        if (fileInfo != null) {
            ...
            FragmentTransaction ft = getFragmentManager().beginTransaction();
            ft.add(renameDialogFragment, RENAME_DIALOG_TAG);
            ft.commitAllowingStateLoss();
...
/* Vanzo:zhangjingzhi on: Mon, 10 Mar 2014 19:20:32 +0800
 * #70047 detail show null
            //detailFragment.show(getFragmentManager(), DETAIL_DIALOG_TAG);
            //getFragmentManager().executePendingTransactions();
            FragmentTransaction ft = getFragmentManager().beginTransaction();
            ft.add(detailFragment, DETAIL_DIALOG_TAG);
            ft.commitAllowingStateLoss();
 */
            detailFragment.show(getFragmentManager(), DETAIL_DIALOG_TAG);
            getFragmentManager().executePendingTransactions();
// End of Vanzo: zhangjingzhi
    ...
    protected class HeavyOperationListener implements FileManagerService.OperationEventListener,
        ...
        public void onTaskPrepare() {
            ...
            FragmentTransaction ft = getFragmentManager().beginTransaction();
            ft.add(heavyDialogFragment, HEAVY_DIALOG_TAG);
            ft.commitAllowingStateLoss();
        }
