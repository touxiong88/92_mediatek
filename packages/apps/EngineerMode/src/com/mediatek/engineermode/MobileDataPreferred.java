        ...
        try {
            ...
            if (mTelephony != null) {
                if (FeatureOption.MTK_GEMINI_SUPPORT) {
                     mTelephony.setGprsTransferTypeGemini(type, PhoneConstants.GEMINI_SIM_1);
                     mTelephony.setGprsTransferTypeGemini(type, PhoneConstants.GEMINI_SIM_2);
                     if (FeatureOption.MTK_GEMINI_3SIM_SUPPORT) {
                         mTelephony.setGprsTransferTypeGemini(type, PhoneConstants.GEMINI_SIM_3);
                     }
                     if (FeatureOption.MTK_GEMINI_4SIM_SUPPORT) {
                         mTelephony.setGprsTransferTypeGemini(type, PhoneConstants.GEMINI_SIM_4);
                     }
                } else {
