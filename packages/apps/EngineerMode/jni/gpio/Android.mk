...
LOCAL_C_INCLUDES := $(JNI_H_INCLUDE) $(LOCAL_PATH) mediatek/external/meta/common/inc mediatek/kernel/include kernel $(LOCAL_PATH)/../chip
LOCAL_SHARED_LIBRARIES := libutils libem_support_jni
