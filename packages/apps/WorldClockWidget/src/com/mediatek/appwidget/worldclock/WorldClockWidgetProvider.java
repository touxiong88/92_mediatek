...
public class WorldClockWidgetProvider extends AppWidgetProvider {
	...
	private static final String DATA_CLEARED = "com.mediatek.intent.action.SETTINGS_PACKAGE_DATA_CLEARED";
	...
	public void onReceive(Context context, Intent intent) {
		...
		} else if (DATA_CLEARED.equals(intent.getAction())) {
            // DATA_CLEARED will be sent out while application's data is cleared,
            // we need receive this broadcast to update all the widgets of world clock.
            String packageName = intent.getStringExtra("packageName");
            if (packageName != null && packageName.equals("com.mediatek.appwidget.worldclock")) {
                Log.d(TAG, "DATA_CLEARED, " + packageName);
                AppWidgetManager appWidgetManager = AppWidgetManager.getInstance(context);
                int[] appwidgetIds = appWidgetManager.getAppWidgetIds(
                        new ComponentName(context, WorldClockWidgetProvider.class));
