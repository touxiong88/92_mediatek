    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CHOOSEACTIVITYREQUESTCODE
            ...
            String citynamefromautoweatherids = data.getExtras().getString(
                    AutoCompleteTextViewActivity.AUTO_WEATHER_ID);
    ...
    protected void onResume() {
        ...
        mListView.setOnItemClickListener(new OnItemClickListener() {
            public void onItemClick(AdapterView<?> arg0, View arg1, int pos,
                ...
                ClockCityInfo cityInfo = setCityInfoByWeatherID(weatherID);
                ...
                ClockCityUtils.savePreferences(mAppwidgetId, cityInfo);
                WorldClockWidgetProvider.updateCity(context, mAppwidgetId, cityInfo);
