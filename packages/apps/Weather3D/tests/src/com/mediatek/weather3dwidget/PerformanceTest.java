...
public class PerformanceTest extends ActivityInstrumentationTestCase2<WeatherActivity> {
    ...
    private void testFPS(Weather.WeatherCondition condition, String fpsFileName) {
    ...
    public void test01SunnyFPS() {
        testFPS(Weather.WeatherCondition.Sunny, "01.sunny.fps.txt");
    }

    public void test02WindyFPS() {
        testFPS(Weather.WeatherCondition.Windy, "02.windy.fps.txt");
    }

    public void test03BlusteryFPS() {
        testFPS(Weather.WeatherCondition.Hurricane, "03.blustery.fps.txt");
    }

    public void test04CloudyFPS() {
        testFPS(Weather.WeatherCondition.Cloudy, "04.cloudy.fps.txt");
    }

    public void test05RainFPS() {
        testFPS(Weather.WeatherCondition.Rain, "05.rain.fps.txt");
    }

    public void test06HeavyRainFPS() {
        testFPS(Weather.WeatherCondition.Downpour, "06.heavy_rain.fps.txt");
    }

    public void test07ThunderFPS() {
        testFPS(Weather.WeatherCondition.Sunny, "07.thunder.fps.txt");
    }

    public void test08SnowFPS() {
        testFPS(Weather.WeatherCondition.Snow, "08.snow.fps.txt");
    }

    public void test09HeavySnowFPS() {
        testFPS(Weather.WeatherCondition.HeavySnow, "09.heavy_snow.fps.txt");
    }

    public void test10SnowRainFPS() {
        testFPS(Weather.WeatherCondition.Sleet, "10.snow_rain.fps.txt");
    }

    public void test11FogFPS() {
        testFPS(Weather.WeatherCondition.Fog, "11.fog.fps.txt");
    }

    public void test12SandFPS() {
        testFPS(Weather.WeatherCondition.Sand, "12.sand.fps.txt");
    }
}