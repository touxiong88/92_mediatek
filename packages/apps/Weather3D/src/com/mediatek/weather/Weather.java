...
public final class Weather {
     ...
     * note:
     *   1 only ERROR_SYSTEM_TIME_NOT_CORRECT, ERROR_NETWORK_NOT_AVAILABLE,ERROR_UPDATE_WEATHER_FAILED are i18n
     * @param errorCodeId
     * @param context
     * @return
     * @throws NameNotFoundException
     */
    public static String getErrorDescription(WeatherUpdateResult result, String cityName, Context context)
            throws NameNotFoundException {
