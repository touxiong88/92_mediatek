    ...
    public void startRemoteActivity(Context context, Intent intent) {
        ...
        switch (actionIndex) {
            ...
            case RemoteActivities.ID_ACTIVITION: {   // activition
                ...
                int activityType = intent.getIntExtra(IpMessageConsts.RemoteActivities.KEY_ACTIVATE_TYPE, IpMessageConsts.ActivateType.OTHER);				
            ...
            case RemoteActivities.ID_CHAT_DETAILS_BY_THREAD_ID: {   // chat_details_by_thread_id
                ...
                NmsStartActivityApi.nmsStartChatDetailsActivity(context, threadId, contactId,messageId, needShowLoadAllMsg, needNewTask);
                ///@}
                break;
            }
