...
public class MessageUtils {
    ...
    public static boolean addShortcutToHomeScr(Context context, short contactId) {
        ...
        if (contactId <= 0 || null == contact) {
            ...
            // intent.addCategory("android.intent.category.DEFAULT");
            intent.setAction(NmsIpMessageConsts.ACTION_OPEN_GROUP);
            intent.setClassName("com.android.mms", "com.android.mms.ui.TransferActivity");
            // intent.putExtra(NmsIpMessageConsts.NMS_ENGINE_CONTACT_ID,
            // contactId);
