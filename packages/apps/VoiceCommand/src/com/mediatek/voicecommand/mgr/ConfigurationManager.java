...
/* Vanzo:libing on: Tue, 22 Apr 2014 17:43:04 +0800
 * bugfix #67842 change voice ui default language to english and sync with system language by faq10060
        if (language == null) {
            return;
        }
...
// End of Vanzo:libing
     ...
     * @return
     */
    public boolean hasOperationPermission(String processname, int mainaction) {
...
//                return mVoiceKeyWordInfos.get(processName).mKeyWordArray;
     ...
     * @return
     */
    public String getProcessName(String featureName) {
        VoiceProcessInfo processinfo = mVoiceProcessInfos.get(featureName);
        if (processinfo == null) {
            return null;
        }
        return processinfo.mProcessName;
    }
