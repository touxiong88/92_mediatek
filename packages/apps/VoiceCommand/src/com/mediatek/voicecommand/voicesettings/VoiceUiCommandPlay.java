...
public class VoiceUiCommandPlay extends PreferenceActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CommandPlayPreference titlePref = new CommandPlayPreference(this, fetchSummary(processID));
        titlePref.setTitle(fetchSummary(processID));
        titlePref.setSelectable(false);
        titlePref.setOrder(0);
        getPreferenceScreen().addPreference(titlePref);
