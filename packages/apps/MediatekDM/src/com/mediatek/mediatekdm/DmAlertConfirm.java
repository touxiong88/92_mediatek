...
/**
 * Alert 1101 processor. Responsible for notify UI to display confirm dialog and
 *  pass the result of user interact to engine.
 * 
 * @author mtk80963
 */
public class DmAlertConfirm implements MmiConfirmation {
    ...
    public MmiResult display(MmiViewContext context, ConfirmCommand command) {
        ...
        if (Utilities.isLawmoLocked()) {
            Log.w(TAG.MMI, "LAWMO locked, confirm alert without showing it.");
