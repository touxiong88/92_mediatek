...
import com.mediatek.mediatekdm.iohandler.setting.DmManNodeIoHandler;
import com.mediatek.mediatekdm.iohandler.setting.DmModNodeIoHandler;
...
public class DmRegister {
    ...
    /**
     * Register Node IO Handlers for nodes under "./Settings/" and "./DevInfo/".
     * 
     * @param treeFileName
     */
    public void registerCCNodeIoHandler(String treeFileName) {
        ...
        uriList.add(DmModNodeIoHandler.URI);
        uriList.add(DmManNodeIoHandler.URI);
        String uriStr = null;
        String itemStr = null;
    ...
    /*
        * return full path of every child of @node. 
        */
...
class NodeIoHandlerFactory {
    ...
    public NodeIoHandler createNodeHandler(String configItem, Uri uri, String parameterString) {
        ...
        String className = "com.mediatek.mediatekdm.iohandler.setting.Dm" + configItem + "NodeIoHandler";
