...
public class DmEntry extends PreferenceActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!bindService(new Intent(this, DmService.class), mConnection, Context.BIND_AUTO_CREATE)) {
            finish();
            return;
        }
        mContext = this;
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        if (Options.USESMSREGISTER && Utilities.getRegisteredSimId(mContext) == -1) {
    ...
    private ServiceConnection mConnection = new ServiceConnection() {
        public void onServiceConnected(ComponentName className, IBinder service) {
            ...
            DmOperationManagerFactory.getInstance().registerObserver(mOperationObserver);
            updateUI();
        }
        ...
        public void onServiceDisconnected(ComponentName className) {
            ...
            DmOperationManagerFactory.getInstance().unregisterObserver(mOperationObserver);
            mFumo = null;
            mService = null;
    ...
    private DmOperationManager mOperationManager = DmOperationManagerFactory.getInstance();
