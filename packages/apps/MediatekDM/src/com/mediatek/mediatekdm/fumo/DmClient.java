 ...
 */
public class DmClient extends DmActivity {
    ...
    private void startToWork() {
        ...
        Log.d(TAG.CLIENT, "Is there an operation in recovery? " + DmOperationManagerFactory.getInstance().isInRecovery());
        if (Options.USEDIRECTINTERNET || DmOperationManagerFactory.getInstance().isInRecovery()) {
    ...
    private void onQueryNewVersion() {
        ...
        deleteFile(FumoManager.FUMO_RESUME_FILE_NAME);
    ...
    private void showDownloadingUI(int opcode) {
        ...
        DmOperation operation = DmOperationManagerFactory.getInstance().current();
            ...
            case DIALOG_CANCELDOWNLOAD:
                return DialogFactory.newAlert(this).setTitle(R.string.cancel).setMessage(R.string.canceldownload)
                        .setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int whichButton) {
                                if (!DmOperationManagerFactory.getInstance().isInRecovery()) {
    ...
    public void onServiceConnected() {
        ...
        mFumo = (FumoManager) mService.getFumoManager();
    ...
    public void onServiceDisconnected() {
        Log.w(TAG.CLIENT, "onServiceDisonnected");
        mFumo = null;
    ...
    private void checkNetwork() {
        Assert.assertTrue("check network should only be used in DM WAP connection.", !Options.USEDIRECTINTERNET);
