...
public class DmOperationManager {
    ...
    public interface IOperationScannerHandler {
        void notify(boolean hasPendingOperations);
    }
    ...
    /**
     * Retry the current operation. This method will decrease the retry counter of current operation. Client should
     * invoke this method after the current operation has timed out.
     */
    ...
    private boolean prepareFolder() {
        ...
        if (!dirFolder.exists()) {
            ...
            if (dirFolder.mkdir()) {
                MTKFileUtil.openPermission(dirFolder.getAbsolutePath());
            } else {
