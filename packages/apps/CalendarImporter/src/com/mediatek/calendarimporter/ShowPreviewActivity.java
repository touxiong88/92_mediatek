...
public class ShowPreviewActivity extends Activity implements ServiceConnectedOperation {
        ...
        Handler handler = new Handler() {
            public void handleMessage(Message msg) {
                ...
                case ProcessorMsgType.PROCESSOR_FINISH:
                    ...
                    if (msg.arg2 > 1) {
                        ///M: add resouceId to display exception alter.
                        setImportErrorView(R.string.not_support_multi_events);
                        return;
                    }
                ...
                case ProcessorMsgType.PROCESSOR_EXCEPTION:
                    ///M: add resouceId to display exception alter.
                    setImportErrorView(R.string.import_vcs_failed);
                    break;
    ...
    ///M: add param to distinguish different exception with different alter.
    private void setImportErrorView(int resoureId) {
        mPreviewText.setVisibility(View.VISIBLE);
        mCancelButton.setVisibility(View.GONE);
        mImportButton.setVisibility(View.GONE);
        mTitleTextView.setText(android.R.string.dialog_alert_title);
        mPreviewText.setText(resoureId);
