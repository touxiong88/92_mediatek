...
public class RcsSettingsProvider extends ContentProvider {
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        private void initialTable(SQLiteDatabase db,String table){
            ...
            addParameter(db, table, RcsSettingsData.CHAT_INVITATION_RINGTONE,          "content://settings/system/notification_sound");
            addParameter(db, table, RcsSettingsData.CHAT_INVITATION_VIBRATE,           RcsSettingsData.FALSE);
            ...
            /**
             * M: Add to achieve the RCS-e set Warning Large image feature. @{
             */
            addParameter(db, table, RcsSettingsData.WARN_IMAGE_TRANSFER_SIZE,          "2048");
            /**
             * @}
             */
            ...
            addParameter(db, table, RcsSettingsData.SIP_TRANSACTION_TIMEOUT,           "300");
             ...
             * M: Add to achieve the RCS-e set Warning Large image feature. @{
             */
            addParameter(db, table, RcsSettingsData.WARNING_LARGE_IMAGE_HINT, RcsSettingsData.TRUE);
            /**
             * @}
             */
            /**
