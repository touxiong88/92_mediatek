...
public abstract class ImsNetworkInterface {
     ...
     * no NAT traversal is detected. +     * @return last known NAT public address discovered by UAC or null if UAC is not registered 
     *           */ 
    ...
    /** 
     *    * Sets the last known NAT public address as discovered by UAC. Gets set to null on unregistering or if no 
     *       * NAT traversal is detected. 
     *            */ 
    
    public void setNatPublicAddress(String natPublicAddress) { 
    	this.natPublicAddress = natPublicAddress; 
    	} 
    /** 
    ...
    /** 
     * Sets the last known NAT public address as discovered by UAC. Gets set to -1 on unregistering or if no 
     * NAT traversal is detected. 
    */ 
	
    public void setNatPublicPort(int natPublicPort) { 
    	this.natPublicPort = natPublicPort; 
    	} 
