...
public class RCSeUtils {
    ...
    public static boolean canShareImage(CallManager cm) {
        ...
        String number = getRCSePhoneNumber(cm);
        if (null != number) {
            return RCSeInCallScreenExtension.isCapabilityToShareImage(number);
        } else {
            if (DBG) {
                log("get rcse phone number failed in canShareImage, return false");
            }
            return false;
        }
    }
    ...
    public static boolean canShareVideo(CallManager cm) {
        ...
        String number = getRCSePhoneNumber(cm);
        if (null != number) {
            return RCSeInCallScreenExtension.isCapabilityToShareVideo(number);
        } else {
            if (DBG) {
