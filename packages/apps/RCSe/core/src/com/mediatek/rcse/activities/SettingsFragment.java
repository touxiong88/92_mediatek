...
public class SettingsFragment extends PreferenceFragment implements
    ...
    private static final String RCS_FORCEUSE_ONLYAPN = "forceUseOnlyApn";
    ...
    public void onCreate(Bundle savedInstanceState) {
         ...
         */ 
        PreferenceCategory generalCategory = (PreferenceCategory) findPreference(RCS_GENERAL);
        final CheckBoxPreference ftAutoPreRoaming = ((CheckBoxPreference) findPreference(PREFERENCE_FT_ACCEPT_ROAMING));
        final CheckBoxPreference ftAutoPreNonRoaming = (CheckBoxPreference)findPreference(PREFERENCE_FT_ACCEPT_NOROAMING);
