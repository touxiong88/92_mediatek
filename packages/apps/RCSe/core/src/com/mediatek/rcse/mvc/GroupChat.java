...
public class GroupChat extends ChatImpl {
    ...
    private  String getGroupSubject()
    {
       return mChatTitle;
    }
    ...
    private class GroupChatListener extends IChatEventListener.Stub {
        ...
        public void handleConferenceEvent(final String contact, final String contactDisplayname,
        	...
        	/* remove extra participant as its going to be added again */
  /*      	try
        	{
        		if(mExtraLocalparticipants !=null)
        		{
        	if (  mExtraLocalparticipants.contains(contact))
          	  mExtraLocalparticipants.remove(contact);
        		}
	        }
        	catch(Exception e)
        	{
    ...
    public void handleInvitation(IChatSession chatSession, ArrayList<IChatMessage> messages, boolean isAutoAccept) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (isAutoAccept) {
                handleReceiveMessage(msg, mCurrentParticipants);
            } else {
