...
public class QuickStartGuideMain extends Activity implements OnCompletionListener, 
    ...
    public void onClick(View v) {
        if (v == mLeftBtn) {
            ...
            if (getString(R.string.skip_button).equals(text)) {
                finishQsg();
                ...
                if (mCurrentStep == mVideoTips.length) {
                    ...
                    mRightBtn.setText(R.string.next);
                }
            ...
            if (getString(R.string.ok_button).equals(text)) {
                ...
                mRightBtn.setText(R.string.next);
            } else if (getString(R.string.next).equals(text)) {
                nextStep();
            } else if (getString(R.string.finish).equals(text)) {
                finishQsg();
            }
        }
    }
    ...
    */
    private void nextStep() {
        if (mCurrentStep == mVideoTips.length - 1) {
            ...
            mRightBtn.setText(R.string.finish);
            mLeftBtn.setText(R.string.play_again);
            mLeftBtn.setVisibility(View.VISIBLE);
            mHideVideo = true;
            mCurrentStep++;
    ...
    */
    private void initLayout() {
        ...
        if (mIsFirstRun) {
            mLeftBtn.setText(R.string.skip_button);
        } else {
