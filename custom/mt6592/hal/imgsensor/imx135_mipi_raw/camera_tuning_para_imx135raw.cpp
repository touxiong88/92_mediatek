...
{{
    ...
    ISPCcmPoly22:{
        ...
        20127,    // i4B_STD
        {  // i4P00[9]
            5695000, -2987500, -140000, -902500, 4340000, -872500, -142500, -1535000, 4250000
        },
        {  // i4P10[9]
            3047298, -3334528, 243018, 7329, -167437, 114215, 89996, -226041, 180257
        },
        {  // i4P01[9]
            2302351, -2546072, 203947, -35333, -421648, 411619, 74759, -713397, 678411
        },
        {  // i4P20[9]
            0, 0, 0, 0, 0, 0, 0, 0, 0
        },
    ...
    // AWB NVRAM
    {
        ...
        {// CCT estimation
            ...
            {// Rotated X coordinate
                -377,    // i4RotatedXCoordinate[0]
                -377,    // i4RotatedXCoordinate[1]
                -183,    // i4RotatedXCoordinate[2]
