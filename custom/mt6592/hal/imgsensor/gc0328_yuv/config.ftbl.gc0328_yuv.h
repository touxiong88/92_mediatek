...
FTABLE_SCENE_INDEP()
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
#if (defined(VANZO_SUB_CAM_CAPTURE_SIZE_1M))
			ITEM_AS_DEFAULT_("1024x768"),
			ITEM_AS_VALUES_(
                "320x240",      "640x480",      "1024x768",     "1280x720",     "1280x768",
				)
#elif (defined(VANZO_SUB_CAM_CAPTURE_SIZE_1M3))
			ITEM_AS_DEFAULT_("1280x960"),
			ITEM_AS_VALUES_(
                "320x240",      "640x480",      "1024x768",     "1280x720",     "1280x768",     "1280x960",
				)
#elif (defined(VANZO_SUB_CAM_CAPTURE_SIZE_2M))
			ITEM_AS_DEFAULT_("1600x1200"),
			ITEM_AS_VALUES_(
                "320x240",      "640x480",      "1024x768",     "1280x720",     "1280x768",     "1280x960",
                "1600x1200",
				)
#elif (defined(VANZO_SUB_CAM_CAPTURE_SIZE_3M))
			ITEM_AS_DEFAULT_("2048x1536"),
			ITEM_AS_VALUES_(
                "320x240",      "640x480",      "1024x768",     "1280x720",     "1280x768",     "1280x960",
                "1600x1200",    "2048x1536",
				)
#elif (defined(VANZO_SUB_CAM_CAPTURE_SIZE_5M))
