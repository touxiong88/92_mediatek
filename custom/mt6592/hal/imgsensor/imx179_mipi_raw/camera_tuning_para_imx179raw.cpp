...
{{
    ...
    ISPCcmPoly22:{
        ...
        29136,    // i4B_STD
        {  // i4P00[9]
            4056000, -1600000, 106000, -504000, 3170000, -108000, 154000, -1464000, 3868000
        },
        {  // i4P10[9]
            1198290, -1467109, 257296, -61390, -67510, 136959, 14873, 8354, -40796
        },
        {  // i4P01[9]
            692966, -880902, 176704, -156460, -205676, 369195, 34377, -404208, 351459
        },
        {  // i4P20[9]
            0, 0, 0, 0, 0, 0, 0, 0, 0
        },
...
const NVRAM_CAMERA_3A_STRUCT CAMERA_3A_NVRAM_DEFAULT_VALUE =
{
    ...
    // AE NVRAM
    {
        ...
        // rHistConfig
        {
            ...
            {86, 108, 135, 148, 170},    // u4HistStretchThres[AE_CCT_STRENGTH_NUM] 
...
{
    #include "camera_tsf_para_imx179raw.h"
    #include "camera_tsf_data_imx179raw.h"
};
