...
{{
    ...
    ISPCcmPoly22:{
        ...
        18602,    // i4B_STD
        {  // i4P00[9]
            5640000, -2825000, -257500, -762500, 4020000, -697500, -127500, -3042500, 5730000
        },
        {  // i4P10[9]
            1228629, -1944226, 719700, -103457, -675844, 779301, 245845, 1658059, -1927511
        },
        {  // i4P01[9]
            1104402, -1725269, 629200, -180679, -824701, 1005380, 71177, 559249, -649843
        },
        {  // i4P20[9]
            0, 0, 0, 0, 0, 0, 0, 0, 0
        },
    ...
    // AWB NVRAM
    {
        ...
        {// CCT estimation
            ...
            {// Rotated X coordinate
                -531,    // i4RotatedXCoordinate[0]
                -426,    // i4RotatedXCoordinate[1]
                -218,    // i4RotatedXCoordinate[2]
