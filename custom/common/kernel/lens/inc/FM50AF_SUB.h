#ifndef _FM50AF_SUB_H
#define _FM50AF_SUB_H

#include <linux/ioctl.h>
//#include "kd_imgsensor.h"

#define FM50AF_SUB_MAGIC 'A'
...
#define FM50AF_SUBIOC_G_MOTORINFO _IOR(FM50AF_SUB_MAGIC,0,stFM50AF_SUB_MotorInfo)

#define FM50AF_SUBIOC_T_MOVETO _IOW(FM50AF_SUB_MAGIC,1,unsigned long)

#define FM50AF_SUBIOC_T_SETINFPOS _IOW(FM50AF_SUB_MAGIC,2,unsigned long)

#define FM50AF_SUBIOC_T_SETMACROPOS _IOW(FM50AF_SUB_MAGIC,3,unsigned long)
#ifdef LensdrvCM3
#define FM50AF_SUBIOC_G_MOTORMETAINFO _IOR(FM50AF_SUB_MAGIC,4,stFM50AF_SUB_MotorMETAInfo)
#endif
