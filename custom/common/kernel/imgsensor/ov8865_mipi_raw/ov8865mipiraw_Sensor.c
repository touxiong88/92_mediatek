...
#define OV8865_ORIENTATION IMAGE_HV_MIRROR
...
void OV8865PreviewSetting(void)
{
	...
	OV8865_write_cmos_sensor(0x380b,0xca);//; Y output size L (0x380b,0xc8)
                                                ...
                                                MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	ov8865.imgMirror = OV8865_ORIENTATION;
	spin_unlock(&ov8865mipiraw_drv_lock);
	
	OV8865SetFlipMirror(OV8865_ORIENTATION);
