...
typedef struct
{
	...
	#define OV8865_FULL_Y_START						    		(2)
	#define OV8865_PV_X_START						    		(2)
	#define OV8865_PV_Y_START						    		(2)
	#define OV8865_VIDEO_X_START								(2)
	#define OV8865_VIDEO_Y_START								(2)
	...
	#define OV8865MIPI_WRITE_ID 	(0x20)	//6c
	#define OV8865MIPI_READ_ID	(0x21)		//6d
