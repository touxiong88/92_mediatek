...
static void OV5693MIPI_Sensor_Init(void)
{
    ...
    */
    ...
    OV5693MIPI_write_cmos_sensor(0x3620,0x54);
    OV5693MIPI_write_cmos_sensor(0x3621,0xc7);
    OV5693MIPI_write_cmos_sensor(0x3622,0x0f);
    ...
    OV5693MIPI_write_cmos_sensor(0x5046,0x0a);  //SOF auto mode 
    OV5693MIPI_write_cmos_sensor(0x5780,0x1c);  //DPC           
    OV5693MIPI_write_cmos_sensor(0x5786,0x20);
    OV5693MIPI_write_cmos_sensor(0x5787,0x10);
    OV5693MIPI_write_cmos_sensor(0x5788,0x18);
    OV5693MIPI_write_cmos_sensor(0x578a,0x04);
    OV5693MIPI_write_cmos_sensor(0x578b,0x02);
    OV5693MIPI_write_cmos_sensor(0x578c,0x02);
    OV5693MIPI_write_cmos_sensor(0x578e,0x06);
    OV5693MIPI_write_cmos_sensor(0x578f,0x02);
    OV5693MIPI_write_cmos_sensor(0x5790,0x02);
