...
static kal_uint16 OV12830Reg2Gain(const kal_uint16 iReg)
{
 ...
 //   return iGain +  (iGain * (iReg & 0x0F)) / 16; //ov12830.realGain
 	iGain = iReg*ov12830.ispBaseGain/16;
	return iGain;
}
...
//		OV12830DB("out of range!\n");
	iReg = Gain*16/ov12830.ispBaseGain;//real gain 0x10=1x
	if(iReg < 0x10)
		{iReg = 0x10;}
...
void OV12830PreviewSetting(void)
{
	...
	OV12830_write_cmos_sensor(0x3680,0xf5);//AM10a
	OV12830_write_cmos_sensor(0x3708,0xe6);
	OV12830_write_cmos_sensor(0x3709,0xc7);
	OV12830_write_cmos_sensor(0x3717,0x03);//AM10a
	OV12830_write_cmos_sensor(0x373a,0x70);//AM10a
	OV12830_write_cmos_sensor(0x373f,0x40);//AM10a
	OV12830_write_cmos_sensor(0x3755,0x03);//AM10a
	OV12830_write_cmos_sensor(0x3758,0x02);//AM10a
	OV12830_write_cmos_sensor(0x3781,0x0c);//AM10a
	OV12830_write_cmos_sensor(0x3795,0x04);//AM10a
	OV12830_write_cmos_sensor(0x3796,0x16);//AM10a
	...
	OV12830_write_cmos_sensor(0x4004,0x02);//0x08 am09
	OV12830_write_cmos_sensor(0x4837,0x0b);
	OV12830_write_cmos_sensor(0x4100,0x50);//AM10a
	OV12830_write_cmos_sensor(0x4101,0xb2);//AM10a
	OV12830_write_cmos_sensor(0x4102,0x34);//AM10a
	OV12830_write_cmos_sensor(0x4104,0xdc);//AM10a
	OV12830_write_cmos_sensor(0x4109,0x62);//AM10a
	OV12830_write_cmos_sensor(0x410a,0x01);//AM10a
...
void OV12830VideoSetting(void)
{
	...
	OV12830_write_cmos_sensor(0x3090,0x02);
	OV12830_write_cmos_sensor(0x3091,0x1C);
	//OV12830_write_cmos_sensor(0x3092,0x01);//0x00
	OV12830_write_cmos_sensor(0x3680,0xf5);//AM10a
	OV12830_write_cmos_sensor(0x3708,0xe6);
	OV12830_write_cmos_sensor(0x3709,0xc7);
	OV12830_write_cmos_sensor(0x3717,0x03);//AM10a
...
void OV12830CaptureSetting24fps(void)
{
	...
	OV12830_write_cmos_sensor(0x3680,0xb5);//AM10a
	OV12830_write_cmos_sensor(0x3708,0xe3);
	OV12830_write_cmos_sensor(0x3709,0xc3);
	OV12830_write_cmos_sensor(0x3717,0x01);//AM10a
	OV12830_write_cmos_sensor(0x373a,0x50);//AM10a
	OV12830_write_cmos_sensor(0x373f,0x02);//AM10a
	OV12830_write_cmos_sensor(0x3755,0x00);//AM10a
	OV12830_write_cmos_sensor(0x3758,0x00);//AM10a
	OV12830_write_cmos_sensor(0x3781,0xc8);//AM10a
	OV12830_write_cmos_sensor(0x3795,0x00);//AM10a
	OV12830_write_cmos_sensor(0x3796,0x84);//AM10a
	OV12830_write_cmos_sensor(0x3801,0x00);
	OV12830_write_cmos_sensor(0x3802,0x00);
	OV12830_write_cmos_sensor(0x3803,0x00);
	OV12830_write_cmos_sensor(0x3805,0x9f);
	...
	OV12830_write_cmos_sensor(0x4100,0x2d); //AM10a
	OV12830_write_cmos_sensor(0x4101,0x22); //AM10a
	OV12830_write_cmos_sensor(0x4102,0x04); //AM10a
	OV12830_write_cmos_sensor(0x4104,0x5c); //AM10a
	OV12830_write_cmos_sensor(0x4109,0xa3); //AM10a
	OV12830_write_cmos_sensor(0x410a,0x03); //AM10a
...
0x30,0x99,0x11,
0x30,0x9c,0x01,
0x30,0xb3,0x54, //AM10a
0x30,0xb4,0x03,
0x30,0xb5,0x04,
0x31,0x06,0x21,//AM10a
0x33,0x04,0x28,
0x33,0x05,0x41,
0x33,0x06,0x30,
0x33,0x08,0x00,
...
0x36,0x67,0x00,
0x36,0x6f,0x20,
0x36,0x80,0xf5,//AM10a 0xb5
0x36,0x82,0x00,
0x37,0x01,0x12,
0x37,0x02,0x88,
0x37,0x08,0xe6,//AM10a
0x37,0x09,0xc7,//AM10a
0x37,0x0b,0xa0,
0x37,0x0d,0x11,
0x37,0x0e,0x00,
0x37,0x17,0x03,//AM10a
0x37,0x1c,0x01,
0x37,0x1f,0x1b,
0x37,0x24,0x10,
0x37,0x26,0x00,
0x37,0x2a,0x09,
0x37,0x39,0xb0,
0x37,0x3a,0x70,//AM10a
0x37,0x3c,0x40,
0x37,0x3f,0x40,//AM10a
0x37,0x55,0x03,//AM10a
0x37,0x58,0x02,//AM10a
0x37,0x6b,0x44,
0x37,0x74,0x10,//add 09/23
0x37,0x7b,0x44,
0x37,0x80,0x22,
0x37,0x81,0x0c,//AM10a //0xc8
0x37,0x83,0x31,
0x37,0x86,0x16,
0x37,0x87,0x02,
0x37,0x95,0x04,//AM10a
0x37,0x96,0x16,//AM10a 0x84
0x37,0x9c,0x0c,
0x37,0xc5,0x00,
0x37,0xc6,0x00,
0x37,0xc7,0x00,
...
0x38,0x29,0x0b,
0x38,0x2b,0x6a,
0x40,0x00,0x18,  //manula load r4006
0x40,0x01,0x06,
0x40,0x02,0x45,
0x40,0x05,0x19,//0x18->0x19 modify 09/23 blc
0x40,0x06,0x20, //am10a
0x40,0x07,0x90,
0x40,0x08,0x24,//am10a 
0x40,0x4e,0x37,
0x40,0x4f,0x8f,
0x40,0x58,0x40,//add for reduce temperature
0x41,0x00,0x50,//0x2d, am10a
0x41,0x01,0xb2,//0x22,am10a
0x41,0x02,0x34,//0x04, am10a
0x41,0x04,0xdc,//0x5c,am10a
0x41,0x09,0x62,//0xxa3,am10a
0x41,0x0a,0x01,//0x03,am10a
0x43,0x00,0xff,
0x43,0x03,0x00,
0x43,0x04,0x08,
0x43,0x07,0x30,
...
0x37,0x55,0x03,//AM10a
0x37,0x58,0x02,//AM10a
0x37,0x81,0x0c,//AM10a
0x37,0x95,0x04,//AM10a
0x37,0x96,0x16,//AM10a
0x38,0x01,0x00,
0x38,0x02,0x00,
0x38,0x03,0x00,
0x38,0x05,0x9f,
...
0x38,0x20,0x14,
0x38,0x21,0x0f,
0x40,0x04,0x02,//am10a 0x08
0x48,0x37,0x0b,
0x41,0x00,0x50,//AM10a
0x41,0x01,0xb2,//AM10a
0x41,0x02,0x34,//AM10a
0x41,0x04,0xdc,//AM10a
0x41,0x09,0x62,//AM10a
0x41,0x0a,0x01,//AM10a
