...
#endif
static  UINT32 OV5647_sensor_mirror_flip = 0;
//#define ACDK
...
void OV5647MIPI_set_mirror(UINT32 image_mirror)
{
    ...
    curr_flip = (OV5647MIPI_read_cmos_sensor(0x3820) & 0xF9);           /* bit[1]-Sensor Flip, bit[2]-ISP Flip */
    curr_mirror = (OV5647MIPI_read_cmos_sensor(0x3821) & 0xF9); /* bit[1]-Sensor Mirror, bit[2]-ISP Mirror */
    ...
    OV5647MIPI_write_cmos_sensor(0x3820, curr_flip);
    OV5647MIPI_write_cmos_sensor(0x3821, curr_mirror);
}
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	OV5647MIPI_set_mirror(OV5647_sensor_mirror_flip);
