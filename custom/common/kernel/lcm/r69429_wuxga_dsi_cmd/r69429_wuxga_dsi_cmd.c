...
{
    /*
    #if (PANEL_USE_EXT_POWER)
    //we use external +/-5V LDO for power supply, move it to dws
	lcm_util.set_gpio_mode(GPIO117,GPIO_MODE_00);
	lcm_util.set_gpio_dir(GPIO117,GPIO_DIR_OUT);
	lcm_util.set_gpio_out(GPIO117,1);
