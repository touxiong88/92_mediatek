...
#if defined(NT35595_LG60_TRULY_FHD)
extern LCM_DRIVER nt35595_fhd_dsi_lcm_drv;
#endif
#if defined(NT35590_AUO47_TRULY_HD)
...
#endif
#if defined(HX8394_LG47_TRULY_HD)
extern LCM_DRIVER hx8394_lg47_truly_lcm_drv;
#endif
#if (defined(R63311_FHD_AUO57_TRULY))
extern LCM_DRIVER r63311_fhd_auo57_truly_lcm_drv;
#endif
#if defined(NT35595_AUO55_LINGLONG_FHD)
extern LCM_DRIVER nt35595_auo55_linglong_fhd_lcm_drv;
#endif

#if defined(NT35596_AUO50_YKL_FHD)
extern LCM_DRIVER nt35596_auo50_ykl_fhd_lcm_drv;
#endif
#if defined(NT35590_AUO50_RUIXIN_HD)
extern LCM_DRIVER nt35590_auo50_ruixin_hd_lcm_drv;
#endif
#if (defined(OTM1283A_CMI50_ZES_HD)||(OTM1283A_CMI50_ZES_HD_ADC))
extern LCM_DRIVER otm1283a_cmi50_zes_hd_lcm_drv;
#endif
#if defined(NT35596_LGD55_CAIHONG_FHD)
extern LCM_DRIVER nt35596_lgd55_caihong_fhd_lcm_drv;
#endif
...
#endif
#if defined(NT35517_HSD50_XYL_QHD)
extern LCM_DRIVER nt35517_hsd50_xyl_qhd_lcm_drv;
#endif
#if defined(OTM1283A_AUO57_YKL_HD)
extern LCM_DRIVER otm1283a_auo57_ykl_hd_lcm_drv;
#endif
#if defined(S6D7AA0X01_BOE70_MJK)
extern LCM_DRIVER s6d7aa0x01_dsi_lcm_drv;
#endif
#if defined(R63311_AUO50_TRULY_FHD)
extern LCM_DRIVER r63311_auo50_truly_fhd_lcm_drv;
#endif
#if defined(OTM9605A_HSD50_ZES_QHD)
extern LCM_DRIVER otm9605a_hsd50_zes_qhd_lcm_drv;
#endif
#if defined(NT35521_LG50_YS_HD)
extern LCM_DRIVER nt35521_lg50_hd_lcm_drv;
#endif
#if (defined(OTM1283A_CMI50_YKL_HD)||(OTM1283A_CMI50_YKL_HD_ADC))
extern LCM_DRIVER otm1283a_cmi50_ykl_hd_lcm_drv;
#endif
#if defined(S6TNMR1X01)
extern LCM_DRIVER s6tnmr1x01_dsi_vdo_lcm_drv;
#endif
#if (defined(NT35590_AUO45_TRULY_HD))
extern LCM_DRIVER nt35590_auo45_truly_lcm_drv;
#endif
#if (defined(OTM1283A_HSD50_HLT_HD)||(OTM1283A_HSD50_HLT_HD_ADC))
extern LCM_DRIVER otm1283a_hsd50_hlt_hd_lcm_drv;
#endif
#if defined(OTM1283A_BOE50_BFT_HD)
extern LCM_DRIVER otm1283a_boe50_bft_hd_lcm_drv;
#endif

#if defined(NT35521_JDI50_LLONG_HD)
extern LCM_DRIVER nt35521_jdi50_llong_hd_lcm_drv;
#endif
#if defined(LSL080AL02_SAM8_BDL_WXGA)
extern LCM_DRIVER lsl080al02_wxga_samsung_lcm_drv;
#endif
#if defined(NT35596_LG50_LLONG_FHD)
extern LCM_DRIVER nt35596_lg50_llong_fhd_lcm_drv;
#endif
#if defined(NT35596_LG55_EST3D_FHD)
extern LCM_DRIVER nt35596_lg55_est3d_fhd_lcm_drv;
#endif

#if defined(NT35521_TM50_LLONG_HD)
extern LCM_DRIVER nt35521_tm50_llong_hd_lcm_drv;
#endif
#if defined(NT35521_TM55_LLONG_HD)
extern LCM_DRIVER nt35521_tm55_llong_hd_lcm_drv;
#endif
#if defined(OTM1283A_AUO50_YKL_HD)
extern LCM_DRIVER otm1283a_auo50_ykl_hd_lcm_drv;
#endif
#if defined(NT35521_CMI7_ZHAOJI_WXGA)
extern LCM_DRIVER nt35521_wxga_cmi_lcm_drv;
#endif
#if defined(R69429_JDI7_TDI_WUXGA)
extern LCM_DRIVER r69429_wuxga_dsi_vdo_lcm_drv;
#endif
#if defined(OTM1283A_AUO55_JMO_HD)
extern LCM_DRIVER otm1283a_auo55_jmo_hd_lcm_drv;
#endif
#if defined(OTM1283A_AUO55_YKL_HD)
extern LCM_DRIVER otm1283a_auo55_ykl_hd_lcm_drv;
#endif
#if defined(RM68191_BOE50_BIFEITE_QHD)
extern LCM_DRIVER rm68191_boe50_bifeite_qhd_lcm_drv;
#endif
#if defined(NT35517_BOE50_BLJ_QHD)
extern LCM_DRIVER nt35517_boe50_blj_qhd_lcm_drv;
#endif
LCM_DRIVER* lcm_driver_list[] = 
{
#if defined(NT35517_BOE50_BLJ_QHD)
    &nt35517_boe50_blj_qhd_lcm_drv,
#endif
#if defined(RM68191_BOE50_BIFEITE_QHD)
    &rm68191_boe50_bifeite_qhd_lcm_drv,
#endif
#if defined(OTM1283A_AUO55_YKL_HD)
    &otm1283a_auo55_ykl_hd_lcm_drv,
#endif
#if defined(OTM1283A_AUO55_JMO_HD)
    &otm1283a_auo55_jmo_hd_lcm_drv,
#endif
#if defined(OTM1283A_AUO50_YKL_HD)
    &otm1283a_auo50_ykl_hd_lcm_drv,
#endif
#if defined(NT35521_TM55_LLONG_HD)
    &nt35521_tm55_llong_hd_lcm_drv,
#endif
#if defined(NT35521_TM50_LLONG_HD)
    &nt35521_tm50_llong_hd_lcm_drv,
#endif
#if defined(NT35596_LG50_LLONG_FHD)
    &nt35596_lg50_llong_fhd_lcm_drv,
#endif
#if defined(NT35596_LG55_EST3D_FHD)
    &nt35596_lg55_est3d_fhd_lcm_drv,
#endif

#if defined(NT35521_JDI50_LLONG_HD)
    &nt35521_jdi50_llong_hd_lcm_drv,
#endif

#if defined(OTM1283A_BOE50_BFT_HD)
    &otm1283a_boe50_bft_hd_lcm_drv,
#endif
#if (defined(OTM1283A_HSD50_HLT_HD)||(OTM1283A_HSD50_HLT_HD_ADC))
	&otm1283a_hsd50_hlt_hd_lcm_drv,
#endif
#if defined(OTM1283A_AUO57_YKL_HD)
    &otm1283a_auo57_ykl_hd_lcm_drv,
#endif

#if defined(NT35517_HSD50_XYL_QHD)
    &nt35517_hsd50_xyl_qhd_lcm_drv,
#endif
#if defined(HX8389B_JDI50_KL_QHD)
    &hx8389b_jdi50_kl_qhd_lcm_drv,
#endif
#if defined(NT35596_LGD55_CAIHONG_FHD)
    &nt35596_lgd55_caihong_fhd_lcm_drv,
#endif
#if (defined(OTM1283A_CMI50_ZES_HD)||(OTM1283A_CMI50_ZES_HD_ADC))
    &otm1283a_cmi50_zes_hd_lcm_drv,
#endif
#if defined(NT35590_AUO50_RUIXIN_HD)
	&nt35590_auo50_ruixin_hd_lcm_drv,
#endif
#if defined(NT35596_AUO50_YKL_FHD)
	&nt35596_auo50_ykl_fhd_lcm_drv,
#endif

#if defined(NT35595_AUO55_LINGLONG_FHD)
	&nt35595_auo55_linglong_fhd_lcm_drv,
#endif
...
#if (defined(R63311_FHD_AUO57_TRULY))
    &r63311_fhd_auo57_truly_lcm_drv,
#endif
...
#endif
#if defined(S6D7AA0X01_BOE70_MJK)
    &s6d7aa0x01_dsi_lcm_drv,
#endif
#if defined(R63311_AUO50_TRULY_FHD)
    &r63311_auo50_truly_fhd_lcm_drv,
#endif
#if defined(OTM9605A_HSD50_ZES_QHD)
        &otm9605a_hsd50_zes_qhd_lcm_drv,
#endif
#if defined(NT35521_LG50_YS_HD)
		&nt35521_lg50_hd_lcm_drv,
#endif
#if (defined(OTM1283A_CMI50_YKL_HD)||(OTM1283A_CMI50_YKL_HD_ADC))
    &otm1283a_cmi50_ykl_hd_lcm_drv,
#endif
#if defined(S6TNMR1X01)
    &s6tnmr1x01_dsi_vdo_lcm_drv,
#endif
#if (defined(NT35590_AUO45_TRULY_HD))
	&nt35590_auo45_truly_lcm_drv,
#endif
#if (defined(LSL080AL02_SAM8_BDL_WXGA))
	&lsl080al02_wxga_samsung_lcm_drv,
#endif
#if (defined(NT35521_CMI7_ZHAOJI_WXGA))
	&nt35521_wxga_cmi_lcm_drv,
#endif
#if defined(R69429_JDI7_TDI_WUXGA)
