...
*/
    ...
    data_array[1]=0x000001c3;//cmd mode
    dsi_set_cmdq(data_array, 2, 1);
    ...
    data_array[4]=0x03000400;//cmd mode
	  data_array[5]=0x00060c00;//cmd mode
    ...
    data_array[1]=0x130904C7;//cmd mode
    data_array[2]=0x3940261B;//cmd mode
	  data_array[3]=0x6A665749;//cmd mode
    data_array[4]=0x13090470;//cmd mode
	  data_array[5]=0x3640261B;//cmd mode
	  data_array[6]=0x6A665F49;//cmd mode
	  data_array[7]=0x00000070;//cmd mode
	  dsi_set_cmdq(data_array, 8, 1);

	  data_array[0]=0x00192902;//Gamma_Setting_B
    data_array[1]=0x130904C8;//cmd mode
    data_array[2]=0x3940261B;//cmd mode
	  data_array[3]=0x6A665749;//cmd mode
    data_array[4]=0x13090470;//cmd mode
	  data_array[5]=0x3640261B;//cmd mode
    ...
    data_array[1]=0x130904C9;//cmd mode
    data_array[2]=0x3940261B;//cmd mode
	  data_array[3]=0x6A665749;//cmd mode
    data_array[4]=0x13090470;//cmd mode
	  data_array[5]=0x3640261B;//cmd mode
    ...
    data_array[4]=0x00019919;//cmd mode
    ...
    data_array[4]=0x0DA0D8A0;//cmd mode
	  data_array[5]=0x22443341;//cmd mode
	  data_array[6]=0x03410270;//cmd mode
	  data_array[7]=0x0000BF3D;//cmd mode
	  dsi_set_cmdq(data_array, 8, 1);

	  data_array[0]=0x00082902;
    data_array[1]=0x000006d5;//cmd mode
    data_array[2]=0x4f014f01;//cmd mode
    dsi_set_cmdq(data_array, 3, 1);
    ...
    data_array[2]=0x00144240;//cmd mode
    dsi_set_cmdq(data_array, 3, 1);
...
LCM_DRIVER r63311_auo50_truly_fhd_lcm_drv=
{
    .name			= "r63311_auo50_truly__fhd",
