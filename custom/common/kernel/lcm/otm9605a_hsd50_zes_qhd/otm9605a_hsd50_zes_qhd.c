...
static unsigned int lcm_compare_id(void)
{
	...
	#if defined(BUILD_LK)
		printf("OTM9605 uboot %s \n", __func__);
		printf("%s id = 0x%08x \n", __func__, id);
	#else
		printk("OTM9605 kernel %s \n", __func__);
		printk("%s id = 0x%08x \n", __func__, id);
	#endif
...
LCM_DRIVER otm9605a_hsd50_zes_qhd_lcm_drv =
{
    .name			= "otm9605a_hsd50_zes_qhd",
