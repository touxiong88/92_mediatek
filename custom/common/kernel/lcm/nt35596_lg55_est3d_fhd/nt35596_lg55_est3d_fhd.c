...
//	MDELAY(100);	
	...
	TC358768_DCS_write_1A_1P(0x11,0x21);//20150515
	TC358768_DCS_write_1A_1P(0x12,0x21);//20150515
...
LCM_DRIVER nt35596_lg55_est3d_fhd_lcm_drv =
{
	.name			= "nt35596_lg55_est3d_fhd",
