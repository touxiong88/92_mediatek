...
static void init_lcm_registers(void)
{
	...
	data_array[3]=0x4a5294a1;
    data_array[4]=0x254b5a93;//cmd mode
	data_array[5]=0xf4a5294a;
	...
	data_array[1]=0x83f730c2;
	data_array[2]=0x00000806;
    dsi_set_cmdq(data_array, 3, 1);
	...
	data_array[1]=0x353230c7;
	data_array[2]=0x4556443b;
	data_array[3]=0x6e696157;
	data_array[4]=0x35323077;
	data_array[5]=0x4556443b;
	data_array[6]=0x6e696157;
	  data_array[7]=0x00000077;//cmd mode
	  dsi_set_cmdq(data_array, 8, 1);

	  data_array[0]=0x00192902;//Gamma_Setting_B
	data_array[1]=0x332f2ac8;
	data_array[2]=0x44554239;
	data_array[3]=0x6f6b6157;
	data_array[4]=0x332f2a77;
	data_array[5]=0x44554239;
	data_array[6]=0x6f6b6157;
	  data_array[7]=0x00000077;//cmd mode
	  dsi_set_cmdq(data_array, 8, 1);

	  data_array[0]=0x00192902;//Gamma_Setting_C
    data_array[1]=0x261e0bc9;//cmd mode
	data_array[2]=0x43523b2e;
	data_array[3]=0x6c6a6156;
    data_array[4]=0x261e0b77;//cmd mode
	data_array[5]=0x43523b2e;
	data_array[6]=0x6c6a6156;
	  data_array[7]=0x00000077;//cmd mode
	  dsi_set_cmdq(data_array, 8, 1);

	  data_array[0]=0x00212902;//Color_enhancement set ce
    data_array[1]=0x808000ca;//cmd mode
    data_array[2]=0x80808080;//cmd mode
	  data_array[3]=0x80200880;//cmd mode
	...
	data_array[1]=0x07e05fcb;//
	data_array[2]=0x000000fa;
...
static void lcm_get_params(LCM_PARAMS *params)
{
		...
		params->dsi.fbk_div =18;  //0x12  // fref=26MHz, fvco=fref*(fbk_div+1)*2/(div1_real*div2_real)
...
#else
    hwPowerOn(MT6322_POWER_LDO_VGP2, VOL_3000, "LCM");
#endif
...
LCM_DRIVER r63311_fhd_auo57_truly_lcm_drv=
{
    .name			= "r63311_fhd_auo57_truly",
