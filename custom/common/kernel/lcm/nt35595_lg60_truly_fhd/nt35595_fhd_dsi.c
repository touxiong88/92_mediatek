...
/* Vanzo:yejianbo on: Tue, 08 Apr 2014 15:23:49 +0800
 * UI performance optimization
	params->dsi.fbk_div = 13;//14;//15;//18;	//0x12  // fref=26MHz, fvco=fref*(fbk_div+1)*2/(div1_real*div2_real)
 */
	params->dsi.fbk_div = 18;//14;//15;//18;	//0x12  // fref=26MHz, fvco=fref*(fbk_div+1)*2/(div1_real*div2_real)
// End of Vanzo: yejianbo
