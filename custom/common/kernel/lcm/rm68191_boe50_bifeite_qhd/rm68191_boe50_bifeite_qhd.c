...
static void lcm_get_params(LCM_PARAMS * params)
{
	...
	params->dsi.horizontal_frontporch = 64;	//21;
	...
	params->dsi.fbk_div = 18 ;//16;	//15;    // fref=26MHz, fvco=fref*(fbk_div+1)*2/(div1_real*div2_real)
}
...
LCM_DRIVER rm68191_boe50_bifeite_qhd_lcm_drv =
{
	.name			= "rm68191_boe50_bifeite_qhd",
