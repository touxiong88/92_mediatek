 ...
 *
 *	ÐÞ¸´IMX135 ÅÄÕÕºó·µ»ØÔ¤ÀÀÆ«°µ sunhouzan 2014-9-26
 *============================================================================
 ****************************************************************************/
...
extern kal_bool otp_update(); //o-film otp code add 
...
//sensorid = IMX135MIPI_SENSOR_ID;
    ...
    {
    	SENSORDB("----ofilm otp add code imx135 err failed!!\n");
    }
    else
    {
    	SENSORDB("----ofilm otp add code imx135 succssful!!\n");
    }
    spin_lock(&imx135_drv_lock);    
