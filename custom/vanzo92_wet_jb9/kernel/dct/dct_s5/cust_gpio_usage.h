...
#define GPIO_CAMERA_SUB_AF_EN_PIN         (GPIO118 | 0x80000000)
#define GPIO_CAMERA_SUB_AF_EN_PIN_M_GPIO  GPIO_MODE_00

#define GPIO_CAMERA_LDO_EN_PIN         (GPIO119 | 0x80000000)
#define GPIO_CAMERA_LDO_EN_PIN_M_GPIO  GPIO_MODE_00

#define GPIO_HALL_EINT_PIN         (GPIO121 | 0x80000000)
