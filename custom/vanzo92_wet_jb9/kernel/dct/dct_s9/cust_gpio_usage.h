...
#define GPIO_KPD_HOMEKEY_EINT_PIN         (GPIO55 | 0x80000000)
#define GPIO_KPD_HOMEKEY_EINT_PIN_M_GPIO  GPIO_MODE_00
#define GPIO_KPD_HOMEKEY_EINT_PIN_M_EINT  GPIO_KPD_HOMEKEY_EINT_PIN_M_GPIO
