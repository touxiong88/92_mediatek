...
#define CUST_EINT_KPD_HOME_NUM              55
#define CUST_EINT_KPD_HOME_DEBOUNCE_CN      256
#define CUST_EINT_KPD_HOME_TYPE							CUST_EINTF_TRIGGER_LOW
#define CUST_EINT_KPD_HOME_DEBOUNCE_EN      CUST_EINT_DEBOUNCE_ENABLE
