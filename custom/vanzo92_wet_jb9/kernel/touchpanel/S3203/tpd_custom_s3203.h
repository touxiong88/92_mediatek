...
#define TPD_HAVE_BUTTON
#define TPD_KEY_SUPPORT	//for s3203 button0 - button7 support
#define TPD_BUTTON_HEIGH        (100)

#if (defined(HD) || defined(CU_HD720) || defined(HD720))
#define CUSTOM_MAX_HEIGHT       1280
#define CUSTOM_MAX_WIDTH        720
#define TPD_KEY_PRODUCT_ADDR    0x59
#elif(defined(CU_FHD) || defined(CMCC_FHD) || defined(FHD))
#define CUSTOM_MAX_HEIGHT       1920
#define CUSTOM_MAX_WIDTH        1080
#define TPD_KEY_PRODUCT_ADDR    0x4c
#endif
...
#elif (defined(HD) || defined(CU_HD720)|| defined(HD720))
