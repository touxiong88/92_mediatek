...
#if defined(DCT_K8)
#define TPD_POWER_SOURCE_CUSTOM MT6322_POWER_LDO_VGP2
#endif
...
#elif (defined(HD) || defined(HD720) || defined(CU_HD720) || defined(CMCC_HD720))
...
#elif (defined(FHD) || defined(CU_FHD) || defined(CMCC_FHD))

#define TPD_KEY_COUNT           3
#define TPD_KEYS                {KEY_MENU,KEY_HOMEPAGE, KEY_BACK}
#define TPD_KEYS_DIM            {{180,2030,100,100},{540,2030,100,100},{900,2030,100,100}}
