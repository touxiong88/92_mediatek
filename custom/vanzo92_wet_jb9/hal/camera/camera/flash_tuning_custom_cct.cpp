...
int getDefaultStrobeNVRam_main(void* data, int* ret_size)
{
	...
	p->tuningPara[0].antiOverLevel = -4;
	p->tuningPara[0].foregroundLevel = -10;
	...
	p->tuningPara[1].antiOverLevel = -4;
	p->tuningPara[1].foregroundLevel = -10;
	...
	p->tuningPara[2].antiOverLevel = -4;
	p->tuningPara[2].foregroundLevel = -10;
	...
	p->tuningPara[3].antiOverLevel = -4;
	p->tuningPara[3].foregroundLevel = -10;
