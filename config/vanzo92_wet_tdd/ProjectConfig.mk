...
AUTO_ADD_GLOBAL_DEFINE_BY_NAME=MTK_ACMT_DEBUG MTK_BT_PROFILE_AVRCP MTK_NVRAM_SECURITY MTK_MMPROFILE_SUPPORT MTK_GPS_SUPPORT MTK_3GDONGLE_SUPPORT MTK_GEMINI_4SIM_SUPPORT EVDO_DT_SUPPORT MTK_CAMCORDER_PROFILE_MID_MP4 CUSTOM_KERNEL_MAGNETOMETER MTK_FM_SUPPORT MTK_MT8193_SUPPORT MTK_TABLET_PLATFORM MTK_AUDIO_RAW_SUPPORT MTK_AUTO_DETECT_MAGNETOMETER MTK_AUDIO_ADPCM_SUPPORT MTK_GEMINI_SMART_3G_SWITCH CUSTOM_KERNEL_OFN MTK_BT_PROFILE_MANAGER MTK_TER_SERVICE MTK_FM_RECORDING_SUPPORT MTK_AUDIO_EXTCODEC_SUPPORT PURE_AP_USE_EXTERNAL_MODEM MTK_DEDICATEDAPN_SUPPORT HAVE_AACENCODE_FEATURE USING_TFA9887_EXTAMP MTK_BT_PROFILE_HIDH MTK_IPV6_SUPPORT MTK_DT_SUPPORT MTK_STEREO3D_WALLPAPER_APP MTK_USER_ROOT_SWITCH MTK_MATV_SERIAL_IF_SUPPORT MTK_MULTIBRIDGE_SUPPORT MTK_BT_PROFILE_PBAP MTK_FAT_ON_NAND MTK_VOICE_UI_SUPPORT MTK_BT_PROFILE_PAN MTK_BT_PROFILE_HFP MTK_BT_21_SUPPORT CUSTOM_KERNEL_BAROMETER MTK_BT_PROFILE_AVRCP14 MTK_DOLBY_DAP_SUPPORT MTK_MASS_STORAGE MTK_BICR_SUPPORT MTK_SEC_VIDEO_PATH_SUPPORT MTK_WMA_PLAYBACK_SUPPORT MTK_BT_PROFILE_BIP MTK_BT_PROFILE_BPP MTK_CTPPPOE_SUPPORT MTK_COMBO_QUICK_SLEEP_SUPPORT MTK_THEMEMANAGER_APP MTK_HDR_SUPPORT MTK_FSCK_TUNE MTK_TMP103_SUPPORT MTK_BQ24158_SUPPORT MTK_DSPIRDBG MTK_TABLET_DRAM MTK_AUTORAMA_SUPPORT MTK_SEC_WFD_VIDEO_PATH_SUPPORT MTK_WORLD_PHONE MTK_BT_PROFILE_MAPS MTK_FM_50KHZ_SUPPORT MTK_WIFI_HOTSPOT_SUPPORT MTK_COMBO_SUPPORT MTK_BT_PROFILE_OPP MTK_IN_HOUSE_TEE_SUPPORT MTK_FLIGHT_MODE_POWER_OFF_MD MTK_RADIOOFF_POWER_OFF_MD MTK_BT_PROFILE_MAPC MTK_SHARED_SDCARD MTK_EMMC_DISCARD MTK_2IN1_SPK_SUPPORT MTK_WVDRM_L1_SUPPORT MTK_VT3G324M_SUPPORT MTK_VIDEO_HEVC_SUPPORT MTK_DMNR_TUNING_AT_MD MTK_MULTI_STORAGE_SUPPORT MTK_CACHE_MERGE_SUPPORT MTK_MT8193_HDCP_SUPPORT MTK_ENABLE_VIDEO_EDITOR MTK_CHIPTEST_INT MTK_EAP_SIM_AKA EVDO_DT_VIA_SUPPORT MTK_WFD_SUPPORT MTK_VIDEO_AUTO_FLASH_SUPPORT MTK_HIGH_RESOLUTION_AUDIO_SUPPORT MTK_BATLOWV_NO_PANEL_ON_EARLY MTK_WAPI_SUPPORT MTK_FD_SUPPORT MTK_DISPLAY_HIGH_RESOLUTION HAVE_ADPCMENCODE_FEATURE MTK_WFD_VIDEO_FORMAT FPGA_EARLY_PORTING MTK_NCP1851_SUPPORT NAND_OTP_SUPPORT MTK_FACEBEAUTY_SUPPORT MTK_ADUPS_FOTA_SUPPORT MTK_AAL_SUPPORT MTK_BQ24156_SUPPORT MTK_VIDEO_VP9_SUPPORT MTK_CAMERA_OT_SUPPORT MTK_PASSPOINT_R1_SUPPORT MTK_BT_40_SUPPORT MTK_BT_PROFILE_FTP MTK_ASF_PLAYBACK_SUPPORT MTK_MULTI_PARTITION_MOUNT_ONLY_SUPPORT MTK_MT8193_HDMI_SUPPORT MTK_HIGH_QUALITY_THUMBNAIL MTK_FAN5402_SUPPORT MTK_IPV6_TETHER_NDP_MODE MTK_FM_RX_SUPPORT MTK_IMAGE_LARGE_MEM_LIMIT MTK_WLAN_CMCC_CTIA_SUPPORT IS_VRF18_USE_6333VRF18 MTK_FM_TX_SUPPORT MTK_MDM_FUMO MTK_OWNER_SDCARD_ONLY_SUPPORT MTK_BRAZIL_CUSTOMIZATION_VIVO MTK_BRAZIL_CUSTOMIZATION_CLARO MTK_LIVE_PHOTO_SUPPORT MTK_ENABLE_MD2 MTK_SWIP_WMAPRO MTK_INTERNAL_MHL_SUPPORT MTK_ENABLE_MD1 MTK_MERGE_INTERFACE_SUPPORT MTK_LCA_RAM_OPTIMIZE MTK_RMVB_PLAYBACK_SUPPORT MTK_NO_NEED_USB_LED MTK_BT_PROFILE_TIMES MTK_NATIVE_3D_SUPPORT MTK_SWCHR_SUPPORT MTK_BT_PROFILE_TIMEC MTK_VOICE_UNLOCK_SUPPORT MTK_UMTS_TDD128_MODE MTK_TETHERING_EEM_SUPPORT MTK_YMAL_SCATTER_FILE_SUPPORT MTK_JAZZ MTK_MATV_ANALOG_SUPPORT MTK_NEW_COMBO_EMMC_SUPPORT MTK_MOBILE_MANAGEMENT MTK_MOTION_TRACK_SUPPORT MTK_BRAZIL_CUSTOMIZATION MTK_BT_PROFILE_SIMAP MTK_MDM_LAWMO MTK_PERF_STATS_SUPPORT MTK_TABLET_PLUGIN_BUILD MTK_WFD_HDCP_TX_SUPPORT MTK_BT_SUPPORT MTK_CAMERA_BSP_SUPPORT MTK_DFO_RESOLUTION_SUPPORT MTK_CTA_SUPPORT MTK_PLATFORM_OPTIMIZE MTK_AIV_SUPPORT MTK_YAML_SCATTER_FILE_SUPPORT MTK_PARTITION_TABLE_PLAIN_TEXT MTK_SMARTBOOK_SUPPORT MTK_NFC_SUPPORT MTK_SDIOAUTOK_SUPPORT MTK_NAND_UBIFS_SUPPORT CUSTOM_KERNEL_GYROSCOPE MTK_MDM_SCOMO MTK_SIM_HOT_SWAP_COMMON_SLOT MTK_AUDIO_DDPLUS_SUPPORT MTK_HANDSFREE_DMNR_SUPPORT MTK_LCEEFT_SUPPORT MTK_EMULATOR_SUPPORT CUSTOM_KERNEL_ACCELEROMETER MTK_ION_SUPPORT MTK_AUTOIP_SUPPORT MTK_MT6333_SUPPORT MTK_BIP_SCWS MTK_WLAN_SUPPORT MTK_PQ_SUPPORT MTK_DRM_PLAYREADY_SUPPORT MTK_TETHERINGIPV6_SUPPORT MTK_UART_USB_SWITCH MTK_IPOH_SUPPORT MTK_AUTO_DETECT_ACCELEROMETER HAVE_CMMB_FEATURE MTK_USES_VR_DYNAMIC_QUALITY_MECHANISM MTK_NEW_PARTITION_TABLE MTK_EMMC_SUPPORT_OTP IS_VCORE_USE_6333VCORE MTK_LCA_ROM_OPTIMIZE MTK_TB_APP_CALL_FORCE_SPEAKER_ON MTK_COMBO_CORE_DUMP_SUPPORT MTK_TB_HW_DEBUG MTK_BT_PROFILE_A2DP MTK_MULTISIM_RINGTONE_SUPPORT TELEPHONY_DFOSET MTK_PRODUCT_INFO_SUPPORT MTK_BEAM_PLUS_SUPPORT MTK_FM_SHORT_ANTENNA_SUPPORT MTK_QVGA_LANDSCAPE_SUPPORT MTK_PM_STATS_SUPPORT MTK_SW_BTCVSD DRAM_1066 MTK_HDMI_HDCP_SUPPORT MTK_HDMI_SUPPORT MTK_GEMINI_3SIM_SUPPORT MTK_INTERNAL_HDMI_SUPPORT IS_VM_USE_6333VM MTK_BT_PROFILE_SPP MTK_KERNEL_POWER_OFF_CHARGING MTK_BT_30_SUPPORT MTK_FAN5405_SUPPORT MTK_DVFS_DISABLE_LOW_VOLTAGE_SUPPORT MTK_MT8193_NFI_SUPPORT MTK_DISABLE_POWER_ON_OFF_VOLTAGE_LIMITATION MTK_HW_ENHANCE SINGLE_PANEL_OUTPUT MTK_SHOW_MSENSOR_TOAST_SUPPORT MTK_LCA_SUPPORT MTK_CTP_RESET_CONFIG MTK_BT_FM_OVER_BT_VIA_CONTROLLER MTK_AUDIO_CHANGE_SUPPORT MTK_DUAL_MIC_SUPPORT MTK_BT_PROFILE_DUN MTK_DHCPV6C_WIFI MTK_WIFI_CALLING_RIL_SUPPORT MTK_BT_PROFILE_PRXM MTK_AUTO_DETECT_ALSPS MTK_FSCK_MSDOS_MTK MTK_DISP_CONFIG_SUPPORT MTK_MAV_SUPPORT MTK_IPV6_TETHER_PD_MODE HAVE_AWBENCODE_FEATURE MTK_BQ24196_SUPPORT MTK_WEB_NOTIFICATION_SUPPORT MTK_MD_SHUT_DOWN_NT MTK_SPH_EHN_CTRL_SUPPORT MTK_BSP_PACKAGE MTK_WB_SPEECH_SUPPORT CUSTOM_KERNEL_ALSPS MTK_VIBSPK_SUPPORT HW_HAVE_TP_THREAD MTK_CLEARMOTION_SUPPORT MTK_BT_PROFILE_PRXR ENCRY_PARTITION_SUPPORT MTK_ADUPS_FOTA_WITH_ICON MTK_DRM_KEY_MNG_SUPPORT MTK_DFO_SUPPORT MTK_BQ27541_SUPPORT MTK_SD_REINIT_SUPPORT MTK_SENSOR_SUPPORT MTK_M4U_SUPPORT MTK_EMMC_SUPPORT MTK_VOIP_ENHANCEMENT_SUPPORT MTK_S3D_SUPPORT MTK_BQ27520_SUPPORT MTK_BQ24297_SUPPORT MTK_2SDCARD_SWAP HAVE_XLOG_FEATURE MTK_WLANBT_SINGLEANT MTK_MSDC1_NOT_SUPPORT_SDR104 VANZO_HIGH_BATTERY_VOLTAGE_SUPPORT VANZO_KP_WAKE_UP_SYS VANZO_SUB_CAM_CAPTURE_SIZE_13M VANZO_SUB_CAM_CAPTURE_SIZE_8M VANZO_SUB_CAM_CAPTURE_SIZE_5M VANZO_SUB_CAM_CAPTURE_SIZE_3M VANZO_MAIN_CAM_CAPTURE_SIZE_5M VANZO_MAIN_CAM_CAPTURE_SIZE_8M VANZO_MAIN_CAM_CAPTURE_SIZE_13M VANZO_MAIN_CAM_CAPTURE_SIZE_14M FT5X06_GESTRUE_SUPPORT VANZO_HOME_KEY_USE_EINT VANZO_GY_BOTTOM VANZO_BUILDIN_BATTERY_SUPPORT VANZO_TOUCHPANEL_GESTURES_SUPPORT VANZO_DOUBLE_CLICK_WAKEUP
AUTO_ADD_GLOBAL_DEFINE_BY_NAME_VALUE=MTK_SIM1_SOCKET_TYPE MTK_TOUCH_PHYSICAL_ROTATION_RELATIVE_TO_LCM MTK_PCB_BATTERY_SENSOR LCM_WIDTH MTK_COMBO_PSM_RX_TH MTK_NFC_SE_NUM MTK_LCM_PHYSICAL_ROTATION EMMC_CHIP CUSTOM_KERNEL_SSW MTK_SINGLE_3DSHOT_SUPPORT MTK_EXTERNAL_MODEM_SLOT MTK_SHARE_MODEM_SUPPORT MTK_NEON_SUPPORT MTK_SHARE_MODEM_CURRENT MTK_COMBO_PSM_TX_TH CUSTOM_KERNEL_MAIN2_IMGSENSOR LCM_HEIGHT MTK_OVERLAY_ENGINE_SUPPORT MTK_SIM2_SOCKET_TYPE VANZO_MAIN_CAM_ROTATION VANZO_SUB_CAM_ROTATION
AUTO_ADD_GLOBAL_DEFINE_BY_VALUE=MTK_PLATFORM CUSTOM_KERNEL_LENS CUSTOM_KERNEL_MAIN_BACKUP_LENS BOOT_LOGO CUSTOM_KERNEL_LCM MTK_MODEM_SUPPORT MTK_ATV_CHIP CUSTOM_KERNEL_MAIN_IMGSENSOR MTK_BT_CHIP MTK_WLAN_CHIP CUSTOM_KERNEL_SUB_BACKUP_IMGSENSOR MTK_IME_INPUT_ENGINE CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR CUSTOM_KERNEL_FLASHLIGHT CUSTOM_KERNEL_SUB_IMGSENSOR CUSTOM_KERNEL_SUB_LENS MTK_AUDIO_BLOUD_CUSTOMPARAMETER_REV CUSTOM_KERNEL_IMGSENSOR MTK_FM_RX_AUDIO MTK_COMBO_CHIP MTK_GPS_CHIP CUSTOM_KERNEL_SUB_BACKUP_LENS CUSTOM_KERNEL_MAIN_LENS MTK_FM_TX_AUDIO MTK_FM_CHIP CUSTOM_KERNEL_MAIN2_IMGSENSOR MTK_IME_HANDWRITING_ENGINE CUSTOM_KERNEL_LEDS CUSTOM_KERNEL_DCT VANZO_ACC_TOP_OR_BOT CUSTOM_KERNEL_HALL CUSTOM_KERNEL_MICDISNOISE CUSTOM_KERNEL_FUELGAUGE
...
# In FPGA development stage, it need to use this config to separate some unused functions.
...
# Support BESLOUDNESS Switch UI in setting page
...
# Use this option to enable/disable OT feature
...
# this feature oprion is for DFO Resolution
...
# This Feature option will be used in order to whether enable Display Configruation support or not on applied platform .
...
# To support mobile management framewokrs
#  To support CTA security certificateion Level 1
MTK_MOBILE_MANAGEMENT=yes

# used to switch the camera featuer :Motion Track
...
# support new format partition table
...
# Support kernel power/performance statistics inquiry
...
# Tablet should use another Voice unlock library, which is different to smart phone.
...
# ???ѿﶵ??WIFI CMCC???ծɡA?۰?apply CTIA mode
MTK_WLAN_CMCC_CTIA_SUPPORT=no

# when the option is opened, WMA Feature is Opened
# 
# when the option is closed, WMA Feature is Closed
# 
...
# Need a configuration to control sil9024.
...
# HW use TFA9887 , SW implement different architecture
...
CUSTOM_MODEM=vanzo92_wet_jb9_tdd128hspa
...
# VANZO GY direction
VANZO_GY_BOTTOM = no
#vanzo build-in battery
VANZO_BUILDIN_BATTERY_SUPPORT = no
#vanzo high battery voltage
VANZO_HIGH_BATTERY_VOLTAGE_SUPPORT=no
#vanzo kp wake up system
VANZO_KP_WAKE_UP_SYS = yes
#vanzo home use eint mode
VANZO_HOME_KEY_USE_EINT =no
#vanzo custom picture size
VANZO_SUB_CAM_CAPTURE_SIZE_3M=no
VANZO_SUB_CAM_CAPTURE_SIZE_5M=no
VANZO_SUB_CAM_CAPTURE_SIZE_8M=no
...
VANZO_MAIN_CAM_CAPTURE_SIZE_14M=no
